//
//  macOS_Widget_Extension.swift
//  macOS Widget Extension
//
//  Created by Mark Howard on 07/05/2023.
//
...
struct macOS_Widget_ExtensionEntryView : View {
...
struct macOS_Widget_Extension_Select: Widget {
    let kind: String = "macOS_Widget_Extension"
    
    var body: some WidgetConfiguration {
        IntentConfiguration(kind: kind, intent: ConfigurationIntent.self, provider: Provider()) { entry in
            macOS_Widget_ExtensionEntryView(entry: entry)
        }
...
@main
struct macOS_Widget_Extension_Widgets: WidgetBundle {
    var body: some Widget {
        macOS_Widget_Extension_Select()
    }
}

struct macOS_Widget_Extension_Previews: PreviewProvider {
    static var previews: some View {
        macOS_Widget_ExtensionEntryView(entry: SelectSimpleEntry(date: Date(), configuration: ConfigurationIntent(), name: "An Unearthly Child", image: "AnUnearthlyChild", story: "1", writer: "Anthony Coburn", doctor: "1st Doctor", airDate: "23 November 1963", url: "dwepisode://anunearthlychild"))
