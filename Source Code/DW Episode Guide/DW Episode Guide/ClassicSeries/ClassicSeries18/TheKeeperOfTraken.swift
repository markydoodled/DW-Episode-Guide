    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheKeeperOfTraken")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheKeeperOfTraken")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheKeeperOfTraken")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheKeeperOfTraken")
                                }) {
                    ...
                    Text("Story No. 114")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 114") as NSString)
                    }
                    Text("Written By - Johnny Byrne")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Keeper_of_Traken")!], applicationActivities: nil)
                        }
                    }
