...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("FullCircleWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("FullCircle")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "FullCircle")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "FullCircle")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Full_Circle_(Doctor_Who)")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("FullCircle")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "FullCircle")
                                }) {
                    ...
                    Text("Story No. 111")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 111") as NSString)
                    }
                    Text("Written By - Andrew Smith")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Andrew Smith") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Full_Circle_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
