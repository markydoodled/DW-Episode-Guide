    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("StateOfDecay")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "StateOfDecay")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "StateOfDecay")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/State_of_Decay_(Doctor_Who)")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                    ...
                    Text("Story No. 112")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 112") as NSString)
                    }
                    Text("Written By - Terrance Dicks")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/State_of_Decay_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
