...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @FetchRequest(entity: MeglosClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<MeglosClass>
        @State var showingShare = false
        @AppStorage("MeglosNotes") var notes = ""
        @AppStorage("MeglosWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("Meglos")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "Meglos")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "Meglos")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Meglos")!]))
            }
            .onAppear() {
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                    ...
                    Text("Story No. 110")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 110") as NSString)
                    }
                    Text("Written By - John Flanagan\nAnd Andrew McCulloch")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - John Flanagan\nAnd Andrew McCulloch") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Meglos")!], applicationActivities: nil)
                        }
                    }
...
struct Meglos_Previews: PreviewProvider {
