...
struct WarriorsGate: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: WarriorsGateClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<WarriorsGateClass>
        @State var showingShare = false
        @AppStorage("WarriorsGateNotes") var notes = ""
        @AppStorage("WarriorsGateWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
            ScrollView {
                HStack {
                    ...
                    Image("WarriorsGate")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "WarriorsGate")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "WarriorsGate")?.tiffRepresentation
                    ...
                    Text("Story No. 113")
                            .font(.title3)
                        Text("Written By - Stephen Gallagher")
                            .font(.title3)
                }
                    Spacer()
                }
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Warriors%27_Gate")!]))
                }
            }
                ...
                Form {
                    HStack {
                        ...
                        Image("WarriorsGate")
                            ...
                            } preview: {Image("WarriorsGate")}
                        Spacer()
                    }
                    Text("Story No. 113")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 113") as NSString)
                    }
                    Text("Written By - Stephen Gallagher")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Stephen Gallagher") as NSString)
                        }
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Warriors%27_Gate")!], applicationActivities: nil)
                        }
                    }
...
struct WarriorsGate_Previews: PreviewProvider {
