...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheCavesOfAndrozaniWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("TheCavesOfAndrozani")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheCavesOfAndrozani")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheCavesOfAndrozani")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Caves_of_Androzani")!]))
                        }
                    }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                    ...
                    Text("Story No. 135")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 135") as NSString)
                    }
                    Text("Written By - Robert Holmes")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Caves_of_Androzani")!], applicationActivities: nil)
                        }
                    }
