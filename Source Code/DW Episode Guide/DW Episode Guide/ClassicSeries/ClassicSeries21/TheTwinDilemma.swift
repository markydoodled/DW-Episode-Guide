    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("TheTwinDilemma")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheTwinDilemma")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheTwinDilemma")?.tiffRepresentation
                    ...
                    .touchBar {
                        ...
                        .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Twin_Dilemma")!]))
                    }
                    .onAppear() {
                        ...
                        Image("TheTwinDilemma")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheTwinDilemma")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheTwinDilemma")! as UIImage)
                            } preview: {Image("TheTwinDilemma")}
                        Spacer()
                    }
                    Text("Story No. 136")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 136") as NSString)
                    }
                    Text("Written By - Anthony Steven")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Anthony Steven") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Twin_Dilemma")!], applicationActivities: nil)
                        }
                    }
