...
struct WarriorsOfTheDeep: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: WarriorsOfTheDeepClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<WarriorsOfTheDeepClass>
        @State var showingShare = false
        @AppStorage("WarriorsOfTheDeepNotes") var notes = ""
        @AppStorage("WarriorsOfTheDeepWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("WarriorsOfTheDeep")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "WarriorsOfTheDeep")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "WarriorsOfTheDeep")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Warriors_of_the_Deep")!]))
                        }
                    }
                        ...
                        Image("WarriorsOfTheDeep")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "WarriorsOfTheDeep")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "WarriorsOfTheDeep")! as UIImage)
                            } preview: {Image("WarriorsOfTheDeep")}
                        Spacer()
                    }
                    Text("Story No. 130")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 130") as NSString)
                    }
                    Text("Written By - Johnny Byrne")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Johnny Byrne") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Warriors_of_the_Deep")!], applicationActivities: nil)
                        }
                    }
...
struct WarriorsOfTheDeep_Previews: PreviewProvider {
