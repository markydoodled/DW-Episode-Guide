...
struct ResurrectionOfTheDaleks: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: ResurrectionOfTheDaleksClass.entity(),
            sortDescriptors: [],
            animation: .default)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("ResurrectionOfTheDaleks")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "ResurrectionOfTheDaleks")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "ResurrectionOfTheDaleks")?.tiffRepresentation
                    ...
                    .touchBar {
                        ...
                        .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Resurrection_of_the_Daleks")!]))
                    }
                    .onAppear() {
                        ...
                        Image("ResurrectionOfTheDaleks")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ResurrectionOfTheDaleks")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ResurrectionOfTheDaleks")! as UIImage)
                            } preview: {Image("ResurrectionOfTheDaleks")}
                        Spacer()
                    }
                    Text("Story No. 133")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 133") as NSString)
                    }
                    Text("Written By - Eric Saward")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Eric Saward") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Resurrection_of_the_Daleks")!], applicationActivities: nil)
                        }
                    }
...
struct ResurrectionOfTheDaleks_Previews: PreviewProvider {
