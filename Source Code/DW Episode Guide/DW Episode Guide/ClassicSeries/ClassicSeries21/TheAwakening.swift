...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheAwakwningWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("TheAwakening")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheAwakening")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheAwakening")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Awakening_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("TheAwakening")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheAwakening")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheAwakening")! as UIImage)
                            } preview: {Image("TheAwakening")}
                        Spacer()
                    }
                    Text("Story No. 131")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 131") as NSString)
                    }
                    Text("Written By - Eric Pringle")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Eric Pringle") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Awakening_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
