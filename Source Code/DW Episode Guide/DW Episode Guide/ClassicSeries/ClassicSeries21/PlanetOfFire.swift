...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("PlanetOfFireWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("PlanetOfFire")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "PlanetOfFire")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "PlanetOfFire")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Planet_of_Fire")!]))
                        }
                    }
                        ...
                        Image("PlanetOfFire")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "PlanetOfFire")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "PlanetOfFire")! as UIImage)
                            } preview: {Image("PlanetOfFire")}
                        Spacer()
                    }
                    Text("Story No. 134")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 134") as NSString)
                    }
                    Text("Written By - Peter Grimwade")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Planet_of_Fire")!], applicationActivities: nil)
                        }
                    }
