                    ...
                    Image("TheDaemons")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheDaemons")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheDaemons")?.tiffRepresentation
                        ...
                        Image("TheDaemons")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheDaemons")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheDaemons")! as UIImage)
                            } preview: {Image("TheDaemons")}
                        Spacer()
                    }
                    Text("Story No. 59")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 59") as NSString)
                    }
                    Text("Written By - 'Guy Leopold'\n(Barry Letts\nAnd Robert Sloman)")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - 'Guy Leopold'\n(Barry Letts\nAnd Robert Sloman)") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Daemons")!], applicationActivities: nil)
                        }
                    }
