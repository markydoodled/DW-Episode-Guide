...
struct TheMindOfEvil: View {
    ...
    @AppStorage("TheMindOfEvilWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheMindOfEvil")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheMindOfEvil")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheMindOfEvil")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Mind_of_Evil")!]))
                }
            }
                        ...
                        Image("TheMindOfEvil")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheMindOfEvil")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheMindOfEvil")! as UIImage)
                            } preview: {Image("TheMindOfEvil")}
                        Spacer()
                    }
                    Text("Story No. 56")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 56") as NSString)
                    }
                    Text("Written By - Don Houghton")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Don Houghton") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Mind_of_Evil")!], applicationActivities: nil)
                        }
                    }
