...
struct TerrorOfTheAutons: View {
    ...
    @AppStorage("TerrorOfTheAutonsWatched") var watched: Bool = false
    #if os(iOS)
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TerrorOfTheAutons")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TerrorOfTheAutons")?.tiffRepresentation
                        ...
                        Image("TerrorOfTheAutons")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TerrorOfTheAutons")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TerrorOfTheAutons")! as UIImage)
                            } preview: {Image("TerrorOfTheAutons")}
                        Spacer()
                    }
                    Text("Story No. 55")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 55") as NSString)
                    }
                    Text("Written By - Robert Holmes")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Terror_of_the_Autons")!], applicationActivities: nil)
                        }
                    }
