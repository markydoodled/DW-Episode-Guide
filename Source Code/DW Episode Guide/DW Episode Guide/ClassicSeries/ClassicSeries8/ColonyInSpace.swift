...
struct ColonyInSpace: View {
    ...
    @AppStorage("ColonyInSpaceWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("ColonyInSpace")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "ColonyInSpace")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "ColonyInSpace")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Colony_in_Space")!]))
                }
            }
                        ...
                        Image("ColonyInSpace")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ColonyInSpace")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ColonyInSpace")! as UIImage)
                            } preview: {Image("ColonyInSpace")}
                        Spacer()
                    }
                    Text("Story No. 58")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 58") as NSString)
                    }
                    Text("Written By - Malcolm Hulke")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Colony_in_Space")!], applicationActivities: nil)
                        }
                    }
