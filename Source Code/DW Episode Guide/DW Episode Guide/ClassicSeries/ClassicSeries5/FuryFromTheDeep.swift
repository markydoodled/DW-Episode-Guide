...
struct FuryFromTheDeep: View {
    ...
    @AppStorage("FuryFromTheDeepWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
            ScrollView {
                HStack {
                    ...
                    Image("FuryFromTheDeep")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "FuryFromTheDeep")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "FuryFromTheDeep")?.tiffRepresentation
                    ...
                    Text("Story No. 42")
                            .font(.title3)
                        Text("Written By - Victor Pemberton")
                            .font(.title3)
                }
                    Spacer()
                }
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Fury_from_the_Deep")!]))
                }
            }
                        ...
                        Image("FuryFromTheDeep")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "FuryFromTheDeep")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "FuryFromTheDeep")! as UIImage)
                            } preview: {Image("FuryFromTheDeep")}
                        Spacer()
                    }
                    Text("Story No. 42")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 42") as NSString)
                    }
                    Text("Written By - Victor Pemberton")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Victor Pemberton") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Fury_from_the_Deep")!], applicationActivities: nil)
                        }
                    }
