...
struct TheWheelInSpace: View {
    ...
    @AppStorage("TheWheelInSpaceWatched") var watched: Bool = false
    ...
    ForEach(items) { item in
                    ...
                    Image("TheWheelInSpace")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheWheelInSpace")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheWheelInSpace")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Wheel_in_Space")!]))
            }
            .onAppear() {
                        ...
                        Image("TheWheelInSpace")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheWheelInSpace")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheWheelInSpace")! as UIImage)
                            } preview: {Image("TheWheelInSpace")}
                        Spacer()
                    }
                    Text("Story No. 43")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 43") as NSString)
                    }
                    Text("Written By - David Whitaker")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Wheel_in_Space")!], applicationActivities: nil)
                        }
                    }
