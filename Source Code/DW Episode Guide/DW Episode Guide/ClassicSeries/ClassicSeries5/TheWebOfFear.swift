...
struct TheWebOfFear: View {
    @Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheWebOfFearClass.entity(),
            sortDescriptors: [],
            animation: .default)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheWebOfFear")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheWebOfFear")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheWebOfFear")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Web_of_Fear")!]))
                }
            }
                        ...
                        Image("TheWebOfFear")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheWebOfFear")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheWebOfFear")! as UIImage)
                            } preview: {Image("TheWebOfFear")}
                        Spacer()
                    }
                    Text("Story No. 41")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 41") as NSString)
                    }
                    Text("Written By - Mervyn Haisman\nAnd Henry Lincoln")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Mervyn Haisman\nAnd Henry Lincoln") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Web_of_Fear")!], applicationActivities: nil)
                        }
                    }
...
struct TheWebOfFear_Previews: PreviewProvider {
