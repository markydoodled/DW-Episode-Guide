...
struct TheTombOfTheCybermen: View {
    ...
    @AppStorage("TheTombOfTheCybermenWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheTombOfTheCybermen")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheTombOfTheCybermen")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheTombOfTheCybermen")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Tomb_of_the_Cybermen")!]))
                }
            }
                        ...
                        Image("TheTombOfTheCybermen")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheTombOfTheCybermen")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheTombOfTheCybermen")! as UIImage)
                            } preview: {Image("TheTombOfTheCybermen")}
                        Spacer()
                    }
                    Text("Story No. 37")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 37") as NSString)
                    }
                    Text("Written By - Kit Pedler\nAnd Gerry Davis")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Kit Pedler\nAnd Gerry Davis") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Tomb_of_the_Cybermen")!], applicationActivities: nil)
                        }
                    }
