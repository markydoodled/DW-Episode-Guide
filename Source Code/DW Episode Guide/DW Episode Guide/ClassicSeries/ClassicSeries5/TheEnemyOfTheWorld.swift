...
struct TheEnemyOfTheWorld: View {
    ...
    @AppStorage("TheEnemyOfTheWorldWatched") var watched: Bool = false
    #if os(iOS)
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheEnemyOfTheWorld")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheEnemyOfTheWorld")?.tiffRepresentation
                        ...
                        Image("TheEnemyOfTheWorld")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheEnemyOfTheWorld")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheEnemyOfTheWorld")! as UIImage)
                            } preview: {Image("TheEnemyOfTheWorld")}
                        Spacer()
                    }
                    Text("Story No. 40")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 40") as NSString)
                    }
                    Text("Written By - David Whitaker")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Enemy_of_the_World")!], applicationActivities: nil)
                        }
                    }
