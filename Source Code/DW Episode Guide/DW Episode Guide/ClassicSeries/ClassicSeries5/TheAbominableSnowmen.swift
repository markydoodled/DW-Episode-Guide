...
struct TheAbominableSnowmen: View {
    ...
    @AppStorage("TheAbominableSnowmenWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheAbominableSnowmen")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheAbominableSnowmen")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheAbominableSnowmen")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Abominable_Snowmen")!]))
            }
            .onAppear() {
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                    ...
                    Text("Story No. 38")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 38") as NSString)
                    }
                    Text("Written By - Mervyn Haisman\nAnd Henry Lincoln")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Abominable_Snowmen")!], applicationActivities: nil)
                        }
                    }
