...
struct TheIceWarriors: View {
    ...
    @AppStorage("TheIceWarriorsWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheIceWarriors")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheIceWarriors")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheIceWarriors")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Ice_Warriors")!]))
                }
            }
                        ...
                        Image("TheIceWarriors")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheIceWarriors")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheIceWarriors")! as UIImage)
                            } preview: {Image("TheIceWarriors")}
                        Spacer()
                    }
                    Text("Story No. 39")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 39") as NSString)
                    }
                    Text("Written By - Brian Hayles")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Ice_Warriors")!], applicationActivities: nil)
                        }
                    }
...
struct TheIceWarriors_Previews: PreviewProvider {
