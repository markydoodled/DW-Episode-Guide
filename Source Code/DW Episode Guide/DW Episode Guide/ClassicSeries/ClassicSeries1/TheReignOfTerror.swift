...
struct TheReignOfTerror: View {
    ...
    @AppStorage("TheReignOfTerrorWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheReignOfTerror")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheReignOfTerror")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheReignOfTerror")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Reign_of_Terror_(Doctor_Who)")!]))
            }
            .onAppear() {
                        ...
                        Image("TheReignOfTerror")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheReignOfTerror")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheReignOfTerror")! as UIImage)
                            } preview: {Image("TheReignOfTerror")}
                        Spacer()
                    }
                    Text("Story No. 8")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 8") as NSString)
                    }
                    Text("Written By - Dennis Spooner")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Reign_of_Terror_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
