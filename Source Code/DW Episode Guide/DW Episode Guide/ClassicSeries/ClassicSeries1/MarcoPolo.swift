        ...
        ForEach(items) { item in
                    ...
                    Image("MarcoPolo")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "MarcoPolo")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "MarcoPolo")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Marco_Polo_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("MarcoPolo")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "MarcoPolo")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "MarcoPolo")! as UIImage)
                            } preview: {Image("MarcoPolo")}
                        Spacer()
                    }
                    Text("Story No. 4")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 4") as NSString)
                    }
                    Text("Written By - John Lucarotti")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Marco_Polo_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
