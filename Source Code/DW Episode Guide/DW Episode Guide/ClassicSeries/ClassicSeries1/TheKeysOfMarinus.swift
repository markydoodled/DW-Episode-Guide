...
struct TheKeysOfMarinus: View {
    ...
    @AppStorage("TheKeysOfMarinusWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheKeysOfMarinus")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheKeysOfMarinus")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheKeysOfMarinus")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Keys_of_Marinus")!]))
            }
            .onAppear() {
                        ...
                        Image("TheKeysOfMarinus")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheKeysOfMarinus")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheKeysOfMarinus")! as UIImage)
                            } preview: {Image("TheKeysOfMarinus")}
                        Spacer()
                    }
                    Text("Story No. 5")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 5") as NSString)
                    }
                    Text("Written By - Terry Nation")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Keys_of_Marinus")!], applicationActivities: nil)
                        }
                    }
