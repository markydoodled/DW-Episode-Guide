...
struct TheSensorites: View {
    ...
    @AppStorage("TheSensoritesWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
            ScrollView {
                HStack {
                    ...
                    Image("TheSensorites")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheSensorites")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheSensorites")?.tiffRepresentation
                    ...
                    Text("Story No. 7")
                            .font(.title3)
                        Text("Written By - Peter R. Newman")
                            .font(.title3)
                }
                    Spacer()
                }
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Sensorites")!]))
                }
            }
                        ...
                        Image("TheSensorites")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheSensorites")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheSensorites")! as UIImage)
                            } preview: {Image("TheSensorites")}
                        Spacer()
                    }
                    Text("Story No. 7")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 7") as NSString)
                    }
                    Text("Written By - Peter R. Newman")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Peter R. Newman") as NSString)
                        }
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Sensorites")!], applicationActivities: nil)
                        }
                    }
