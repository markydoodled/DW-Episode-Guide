...
@Environment(\.managedObjectContext) private var viewContext
    ...
    @AppStorage("TheEdgeOfDestructionWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheEdgeOfDestruction")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheEdgeOfDestruction")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheEdgeOfDestruction")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Edge_of_Destruction")!]))
                }
            }
                        ...
                        Image("TheEdgeOfDestruction")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheEdgeOfDestruction")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheEdgeOfDestruction")! as UIImage)
                            } preview: {Image("TheEdgeOfDestruction")}
                        Spacer()
                    }
                    Text("Story No. 3")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 3") as NSString)
                    }
                    Text("Written By - David Whitaker")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Edge_of_Destruction")!], applicationActivities: nil)
                        }
                    }
