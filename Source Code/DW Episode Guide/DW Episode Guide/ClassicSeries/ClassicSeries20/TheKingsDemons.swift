...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheKingsDemonsWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("TheKingsDemons")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheKingsDemons")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheKingsDemons")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_King%27s_Demons")!]))
                        }
                    }
                        ...
                        Image("TheKingsDemons")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheKingsDemons")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheKingsDemons")! as UIImage)
                            } preview: {Image("TheKingsDemons")}
                        Spacer()
                    }
                    Text("Story No. 128")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 128") as NSString)
                    }
                    Text("Written By - Terence Dudley")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_King%27s_Demons")!], applicationActivities: nil)
                        }
                    }
