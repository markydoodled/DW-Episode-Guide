...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("EnlightenmentWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("Enlightenment")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "Enlightenment")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "Enlightenment")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Enlightenment_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("Enlightenment")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Enlightenment")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Enlightenment")! as UIImage)
                            } preview: {Image("Enlightenment")}
                        Spacer()
                    }
                    Text("Story No. 127")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 127") as NSString)
                    }
                    Text("Written By - Barbara Clegg")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Barbara Clegg") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Enlightenment_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
