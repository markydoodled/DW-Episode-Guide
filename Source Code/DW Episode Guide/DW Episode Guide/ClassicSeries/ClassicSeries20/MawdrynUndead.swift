...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("MawdrynUndeadWatched") var watched: Bool = false
                            ...
                            Image("MawdrynUndead")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "MawdrynUndead")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "MawdrynUndead")?.tiffRepresentation
                        ...
                        Image("MawdrynUndead")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "MawdrynUndead")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "MawdrynUndead")! as UIImage)
                            } preview: {Image("MawdrynUndead")}
                        Spacer()
                    }
                    Text("Story No. 125")
                    .onDrag {
