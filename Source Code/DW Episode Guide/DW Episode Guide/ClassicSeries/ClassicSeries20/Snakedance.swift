...
struct Snakedance: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: SnakedanceClass.entity(),
            sortDescriptors: [],
            animation: .default)
        ...
        ForEach(items) { item in
                            ...
                            Image("Snakedance")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "Snakedance")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "Snakedance")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Snakedance")!]))
                        }
                    }
                        ...
                        Image("Snakedance")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Snakedance")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Snakedance")! as UIImage)
                            } preview: {Image("Snakedance")}
                        Spacer()
                    }
                    Text("Story No. 124")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 124") as NSString)
                    }
                    Text("Written By - Christopher Bailey")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Christopher Bailey") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Snakedance")!], applicationActivities: nil)
                        }
                    }
...
struct Snakedance_Previews: PreviewProvider {
