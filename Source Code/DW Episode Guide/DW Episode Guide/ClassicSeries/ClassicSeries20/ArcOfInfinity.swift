    ...
    var body: some View {
                            ...
                            Image("ArcOfInfinity")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "ArcOfInfinity")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "ArcOfInfinity")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("ArcOfInfinity")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ArcOfInfinity")
                                }) {
                    ...
                    Text("Story No. 123")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 123") as NSString)
                    }
                    Text("Written By - Johnny Byrne")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Arc_of_Infinity")!], applicationActivities: nil)
                        }
                    }
