    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("Terminus")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "Terminus")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "Terminus")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Terminus_(Doctor_Who)")!]))
                        }
                    }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("Terminus")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Terminus")
                                }) {
                    ...
                    Text("Story No. 126")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 126") as NSString)
                    }
                    Text("Written By - Stephen Gallagher")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Terminus_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
