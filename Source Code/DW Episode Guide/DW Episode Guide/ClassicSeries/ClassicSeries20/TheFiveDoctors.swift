...
struct TheFiveDoctors: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheFiveDoctorsClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheFiveDoctorsClass>
        @State var showingShare = false
        @AppStorage("TheFiveDoctorsNotes") var notes = ""
        @AppStorage("TheFiveDoctorsWatched") var watched: Bool = false
                            ...
                            Image("TheFiveDoctors")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheFiveDoctors")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheFiveDoctors")?.tiffRepresentation
                    ...
                    .toolbar {
                     ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Five_Doctors")!]))
                        }
                    }
                ...
                Form {
                    HStack {
                        ...
                        Image("TheFiveDoctors")
                            ...
                            } preview: {Image("TheFiveDoctors")}
                        Spacer()
                    }
                    Text("Story No. 129")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 129") as NSString)
                    }
                    Text("Written By - Terrance Dicks")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Terrance Dicks") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Five_Doctors")!], applicationActivities: nil)
                        }
                    }
...
struct TheFiveDoctors_Previews: PreviewProvider {
