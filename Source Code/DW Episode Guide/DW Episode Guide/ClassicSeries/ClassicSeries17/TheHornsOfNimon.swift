...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheHornsOfNimonWatched") var watched: Bool = false
    #if os(iOS)
                        ...
                        Image("TheHornsOfNimon")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheHornsOfNimon")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheHornsOfNimon")! as UIImage)
                            } preview: {Image("TheHornsOfNimon")}
                        Spacer()
                    }
                    Text("Story No. 108")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 108") as NSString)
                    }
                    Text("Written By - Anthony Read")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Anthony Read") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Horns_of_Nimon")!], applicationActivities: nil)
                        }
                    }
