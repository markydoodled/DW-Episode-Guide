        ...
        ForEach(items) { item in
                    ...
                    Image("Shada")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "Shada")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "Shada")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Shada_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("Shada")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Shada")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Shada")! as UIImage)
                            } preview: {Image("Shada")}
                        Spacer()
                    }
                    Text("Story No. 108.5")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 108.5") as NSString)
                    }
                    Text("Written By - Douglas Adams")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Shada_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
