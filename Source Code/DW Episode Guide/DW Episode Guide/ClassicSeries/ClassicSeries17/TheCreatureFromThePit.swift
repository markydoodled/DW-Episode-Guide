...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheCreatureFromThePitWatched") var watched: Bool = false
    #if os(iOS)
                    ...
                    Image("TheCreatureFromThePit")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheCreatureFromThePit")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheCreatureFromThePit")?.tiffRepresentation
                        ...
                        Image("TheCreatureFromThePit")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheCreatureFromThePit")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheCreatureFromThePit")! as UIImage)
                            } preview: {Image("TheCreatureFromThePit")}
                        Spacer()
                    }
                    Text("Story No. 106")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 106") as NSString)
                    }
                    Text("Written By - David Fisher")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Creature_from_the_Pit")!], applicationActivities: nil)
                        }
                    }
