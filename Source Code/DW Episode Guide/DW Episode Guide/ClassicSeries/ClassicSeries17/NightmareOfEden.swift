        ...
        ForEach(items) { item in
                    ...
                    Image("NightmareOfEden")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "NightmareOfEden")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "NightmareOfEden")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Nightmare_of_Eden")!]))
                }
            }
                        ...
                        Image("NightmareOfEden")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "NightmareOfEden")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "NightmareOfEden")! as UIImage)
                            } preview: {Image("NightmareOfEden")}
                        Spacer()
                    }
                    Text("Story No. 107")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 107") as NSString)
                    }
                    Text("Written By - Bob Baker")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Bob Baker") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Nightmare_of_Eden")!], applicationActivities: nil)
                        }
                    }
