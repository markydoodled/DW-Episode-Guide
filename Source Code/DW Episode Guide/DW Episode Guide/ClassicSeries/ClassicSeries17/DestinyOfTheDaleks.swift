...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("DestinyOfTheDaleksWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("DestinyOfTheDaleks")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "DestinyOfTheDaleks")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "DestinyOfTheDaleks")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Destiny_of_the_Daleks")!]))
            }
            .onAppear() {
                        ...
                        Image("DestinyOfTheDaleks")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "DestinyOfTheDaleks")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "DestinyOfTheDaleks")! as UIImage)
                            } preview: {Image("DestinyOfTheDaleks")}
                        Spacer()
                    }
                    Text("Story No. 104")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 104") as NSString)
                    }
                    Text("Written By - Terry Nation")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Destiny_of_the_Daleks")!], applicationActivities: nil)
                        }
                    }
