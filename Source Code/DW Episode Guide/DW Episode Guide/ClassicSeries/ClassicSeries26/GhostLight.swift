        ...
        ForEach(items) { item in
                            ...
                            Image("GhostLight")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "GhostLight")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "GhostLight")?.tiffRepresentation
                    ...
                    .toolbar {
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Ghost_Light_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("GhostLight")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "GhostLight")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "GhostLight")! as UIImage)
                            } preview: {Image("GhostLight")}
                        Spacer()
                    }
                    Text("Story No. 153")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 153") as NSString)
                    }
                    Text("Written By - Marc Platt")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Marc Platt") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Ghost_Light_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
...
struct GhostLight_Previews: PreviewProvider {
