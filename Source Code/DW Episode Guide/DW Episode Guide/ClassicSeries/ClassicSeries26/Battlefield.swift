...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("BattlefieldWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("Battlefield")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "Battlefield")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "Battlefield")?.tiffRepresentation
                    ...
                    .touchBar {
                        ...
                        .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Battlefield_(Doctor_Who)")!]))
                    }
                    .onAppear() {
                        ...
                        Image("Battlefield")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Battlefield")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Battlefield")! as UIImage)
                            } preview: {Image("Battlefield")}
                        Spacer()
                    }
                    Text("Story No. 152")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 152") as NSString)
                    }
                    Text("Written By - Ben Aaronovitch")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Battlefield_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
