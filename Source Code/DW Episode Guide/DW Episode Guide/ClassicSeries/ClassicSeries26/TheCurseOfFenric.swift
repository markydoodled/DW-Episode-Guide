...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheCurseOfFenricWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("TheCurseOfFenric")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheCurseOfFenric")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheCurseOfFenric")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Curse_of_Fenric")!]))
                        }
                    }
                        ...
                        Image("TheCurseOfFenric")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheCurseOfFenric")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheCurseOfFenric")! as UIImage)
                            } preview: {Image("TheCurseOfFenric")}
                        Spacer()
                    }
                    Text("Story No. 154")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 154") as NSString)
                    }
                    Text("Written By - Ian Briggs")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Ian Briggs") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Curse_of_Fenric")!], applicationActivities: nil)
                        }
                    }
