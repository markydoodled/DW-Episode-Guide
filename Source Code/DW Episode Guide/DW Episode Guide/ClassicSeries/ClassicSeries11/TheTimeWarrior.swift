...
struct TheTimeWarrior: View {
    ...
    @AppStorage("TheTimeWarriorWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheTimeWarrior")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheTimeWarrior")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheTimeWarrior")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Time_Warrior")!]))
                }
            }
                        ...
                        Image("TheTimeWarrior")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheTimeWarrior")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheTimeWarrior")! as UIImage)
                            } preview: {Image("TheTimeWarrior")}
                        Spacer()
                    }
                    Text("Story No. 70")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 70") as NSString)
                    }
                    Text("Written By - Robert Holmes")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Time_Warrior")!], applicationActivities: nil)
                        }
                    }
