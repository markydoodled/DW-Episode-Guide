...
struct PlanetOfTheSpiders: View {
    ...
    @AppStorage("PlanetOfTheSpidersWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("PlanetOfTheSpiders")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "PlanetOfTheSpiders")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "PlanetOfTheSpiders")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Planet_of_the_Spiders")!]))
                }
            }
                        ...
                        Image("PlanetOfTheSpiders")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "PlanetOfTheSpiders")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "PlanetOfTheSpiders")! as UIImage)
                            } preview: {Image("PlanetOfTheSpiders")}
                        Spacer()
                    }
                    Text("Story No. 74")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 74") as NSString)
                    }
                    Text("Written By - Robert Sloman")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Planet_of_the_Spiders")!], applicationActivities: nil)
                        }
                    }
