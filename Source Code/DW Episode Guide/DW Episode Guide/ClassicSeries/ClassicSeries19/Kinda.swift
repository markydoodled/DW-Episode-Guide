        ...
        ForEach(items) { item in
                            ...
                            Image("Kinda")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "Kinda")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "Kinda")?.tiffRepresentation
                    ...
                    .toolbar {
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Kinda_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("Kinda")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Kinda")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Kinda")! as UIImage)
                            } preview: {Image("Kinda")}
                        Spacer()
                    }
                    Text("Story No. 118")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 118") as NSString)
                    }
                    Text("Written By - Christopher Bailey")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Kinda_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
