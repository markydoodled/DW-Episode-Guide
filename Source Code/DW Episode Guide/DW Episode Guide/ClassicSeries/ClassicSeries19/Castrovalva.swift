        ...
        ForEach(items) { item in
                            ...
                            Image("Castrovalva")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "Castrovalva")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "Castrovalva")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Castrovalva_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("Castrovalva")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Castrovalva")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Castrovalva")! as UIImage)
                            } preview: {Image("Castrovalva")}
                        Spacer()
                    }
                    Text("Story No. 116")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 116") as NSString)
                    }
                    Text("Written By - Christopher H. Bidmead")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Castrovalva_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
