...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheVisitationWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("TheVisitation")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheVisitation")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheVisitation")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Visitation_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("TheVisitation")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheVisitation")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheVisitation")! as UIImage)
                            } preview: {Image("TheVisitation")}
                        Spacer()
                    }
                    Text("Story No. 119")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 119") as NSString)
                    }
                    Text("Written By - Eric Saward")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Visitation_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
