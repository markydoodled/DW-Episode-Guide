...
struct TimeFlight: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TimeFlightClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TimeFlightClass>
        @State var showingShare = false
        @AppStorage("TimeFlightNotes") var notes = ""
        @AppStorage("TimeFlightWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Time-Flight")!]))
                        }
                    }
...
struct TimeFlight_Previews: PreviewProvider {
