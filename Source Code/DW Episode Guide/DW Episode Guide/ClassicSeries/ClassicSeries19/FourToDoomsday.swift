...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("FourToDoomsdayWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                            ...
                            Image("FourToDoomsday")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "FourToDoomsday")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "FourToDoomsday")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Four_to_Doomsday")!]))
                        }
                    }
                        ...
                        Image("FourToDoomsday")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "FourToDoomsday")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "FourToDoomsday")! as UIImage)
                            } preview: {Image("FourToDoomsday")}
                        Spacer()
                    }
                    Text("Story No. 117")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 117") as NSString)
                    }
                    Text("Written By - Terence Dudley")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Four_to_Doomsday")!], applicationActivities: nil)
                        }
                    }
