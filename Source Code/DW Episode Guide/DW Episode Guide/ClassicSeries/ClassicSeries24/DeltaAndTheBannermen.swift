        ...
        ForEach(items) { item in
                            ...
                            Image("DeltaAndTheBannermen")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "DeltaAndTheBannermen")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "DeltaAndTheBannermen")?.tiffRepresentation
                    ...
                    .toolbar {
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Delta_and_the_Bannermen")!]))
                        }
                    }
                        ...
                        Image("DeltaAndTheBannermen")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "DeltaAndTheBannermen")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "DeltaAndTheBannermen")! as UIImage)
                            } preview: {Image("DeltaAndTheBannermen")}
                        Spacer()
                    }
                    Text("Story No. 146")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 146") as NSString)
                    }
                    Text("Written By - Malcolm Kohll")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Malcolm Kohll") as NSString)
                        }
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Delta_and_the_Bannermen")!], applicationActivities: nil)
                        }
                    }
