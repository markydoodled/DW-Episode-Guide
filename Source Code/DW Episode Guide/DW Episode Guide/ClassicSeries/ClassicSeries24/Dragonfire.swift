    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("Dragonfire")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "Dragonfire")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "Dragonfire")?.tiffRepresentation
                    ...
                    .touchBar {
                        ...
                        .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Dragonfire_(Doctor_Who)")!]))
                    }
                    .onAppear() {
                        ...
                        Image("Dragonfire")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Dragonfire")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Dragonfire")! as UIImage)
                            } preview: {Image("Dragonfire")}
                        Spacer()
                    }
                    Text("Story No. 147")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 147") as NSString)
                    }
                    Text("Written By - Ian Briggs")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Dragonfire_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
