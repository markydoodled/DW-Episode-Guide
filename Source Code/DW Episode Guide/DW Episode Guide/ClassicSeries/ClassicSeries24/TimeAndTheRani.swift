...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TimeAndTheRaniWatched") var watched: Bool = false
    #if os(iOS)
                    ...
                    ScrollView {
                        HStack {
                            ...
                            Image("TimeAndTheRani")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "TimeAndTheRani")?.tiffRepresentation
                        ...
                        Image("TimeAndTheRani")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TimeAndTheRani")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TimeAndTheRani")! as UIImage)
                            } preview: {Image("TimeAndTheRani")}
                        Spacer()
                    }
                    Text("Story No. 144")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 144") as NSString)
                    }
                    Text("Written By - Pip And\nJane Baker")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Time_and_the_Rani")!], applicationActivities: nil)
                        }
                    }
