    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("SpearheadFromSpace")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "SpearheadFromSpace")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "SpearheadFromSpace")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Spearhead_from_Space")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("SpearheadFromSpace")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "SpearheadFromSpace")
                                }) {
                    ...
                    Text("Story No. 51")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 51") as NSString)
                    }
                    Text("Written By - Robert Holmes")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Spearhead_from_Space")!], applicationActivities: nil)
                        }
                    }
