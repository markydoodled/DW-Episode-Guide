...
struct TheAmbassadorsOfDeath: View {
    ...
    @AppStorage("TheAmbassadorsOfDeathWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheAmbassadorsOfDeath")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheAmbassadorsOfDeath")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheAmbassadorsOfDeath")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Ambassadors_of_Death")!]))
                }
            }
                        ...
                        Image("TheAmbassadorsOfDeath")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheAmbassadorsOfDeath")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheAmbassadorsOfDeath")! as UIImage)
                            } preview: {Image("TheAmbassadorsOfDeath")}
                        Spacer()
                    }
                    Text("Story No. 53")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 53") as NSString)
                    }
                    Text("Written By - David Whitaker")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - David Whitaker") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Ambassadors_of_Death")!], applicationActivities: nil)
                        }
                    }
