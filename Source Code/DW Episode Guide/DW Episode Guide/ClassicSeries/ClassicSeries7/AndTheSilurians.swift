...
struct AndTheSilurians: View {
    ...
    @AppStorage("AndTheSiluriansWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("AndTheSilurians")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "AndTheSilurians")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "AndTheSilurians")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Doctor_Who_and_the_Silurians")!]))
                }
            }
                        ...
                        Image("AndTheSilurians")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "AndTheSilurians")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "AndTheSilurians")! as UIImage)
                            } preview: {Image("AndTheSilurians")}
                        Spacer()
                    }
                    Text("Story No. 52")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 52") as NSString)
                    }
                    Text("Written By - Malcolm Hulke")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Doctor_Who_and_the_Silurians")!], applicationActivities: nil)
                        }
                    }
