...
struct GenesisOfTheDaleks: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: GenesisOfTheDaleksClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<GenesisOfTheDaleksClass>
        @State var showingShare = false
        @AppStorage("GenesisOfTheDaleksNotes") var notes = ""
        @AppStorage("GenesisOfTheDaleksWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("GenesisOfTheDaleks")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "GenesisOfTheDaleks")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "GenesisOfTheDaleks")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Genesis_of_the_Daleks")!]))
                }
            }
                        ...
                        Image("GenesisOfTheDaleks")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "GenesisOfTheDaleks")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "GenesisOfTheDaleks")! as UIImage)
                            } preview: {Image("GenesisOfTheDaleks")}
                        Spacer()
                    }
                    Text("Story No. 78")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 78") as NSString)
                    }
                    Text("Written By - Terry Nation")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Genesis_of_the_Daleks")!], applicationActivities: nil)
                        }
                    }
...
struct GenesisOfTheDaleks_Previews: PreviewProvider {
