...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("RevengeOfTheCybermenWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("RevengeOfTheCybermen")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "RevengeOfTheCybermen")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "RevengeOfTheCybermen")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Revenge_of_the_Cybermen")!]))
            }
            .onAppear() {
                        ...
                        Image("RevengeOfTheCybermen")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "RevengeOfTheCybermen")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "RevengeOfTheCybermen")! as UIImage)
                            } preview: {Image("RevengeOfTheCybermen")}
                        Spacer()
                    }
                    Text("Story No. 79")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 79") as NSString)
                    }
                    Text("Written By - Gerry Davis")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Gerry Davis") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Revenge_of_the_Cybermen")!], applicationActivities: nil)
                        }
                    }
