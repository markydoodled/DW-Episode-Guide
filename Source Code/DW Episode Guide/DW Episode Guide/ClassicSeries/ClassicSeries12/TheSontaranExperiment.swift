...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheSontaranExperimentWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheSontaranExperiment")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheSontaranExperiment")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheSontaranExperiment")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Sontaran_Experiment")!]))
                }
            }
                        ...
                        Image("TheSontaranExperiment")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheSontaranExperiment")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheSontaranExperiment")! as UIImage)
                            } preview: {Image("TheSontaranExperiment")}
                        Spacer()
                    }
                    Text("Story No. 77")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 77") as NSString)
                    }
                    Text("Written By - Bob Baker\nAnd Dave Martin")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Sontaran_Experiment")!], applicationActivities: nil)
                        }
                    }
