...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheTwoDoctorsWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("TheTwoDoctors")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheTwoDoctors")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheTwoDoctors")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Two_Doctors")!]))
                        }
                    }
                        ...
                        Image("TheTwoDoctors")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheTwoDoctors")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheTwoDoctors")! as UIImage)
                            } preview: {Image("TheTwoDoctors")}
                        Spacer()
                    }
                    Text("Story No. 140")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 140") as NSString)
                    }
                    Text("Written By - Robert Holmes")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Two_Doctors")!], applicationActivities: nil)
                        }
                    }
