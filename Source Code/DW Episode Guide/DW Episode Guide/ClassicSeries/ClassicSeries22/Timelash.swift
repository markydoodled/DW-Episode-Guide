    ...
    var body: some View {
                            ...
                            Image("Timelash")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "Timelash")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "Timelash")?.tiffRepresentation
                    ...
                    .toolbar {
                     ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Timelash")!]))
                        }
                    }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("Timelash")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Timelash")
                                }) {
                    ...
                    Text("Story No. 141")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 141") as NSString)
                    }
                    Text("Written By - Glen McCoy")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Glen McCoy") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Timelash")!], applicationActivities: nil)
                        }
                    }
