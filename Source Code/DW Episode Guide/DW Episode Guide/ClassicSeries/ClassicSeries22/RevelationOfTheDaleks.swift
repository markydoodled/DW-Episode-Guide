...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("RevelationOfTheDaleksWatched") var watched: Bool = false
    #if os(iOS)
                    ...
                    ScrollView {
                        HStack {
                            ...
                            Image("RevelationOfTheDaleks")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "RevelationOfTheDaleks")?.tiffRepresentation
                        ...
                        Image("RevelationOfTheDaleks")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "RevelationOfTheDaleks")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "RevelationOfTheDaleks")! as UIImage)
                            } preview: {Image("RevelationOfTheDaleks")}
                        Spacer()
                    }
                    Text("Story No. 142")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 142") as NSString)
                    }
                    Text("Written By - Eric Saward")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Revelation_of_the_Daleks")!], applicationActivities: nil)
                        }
                    }
