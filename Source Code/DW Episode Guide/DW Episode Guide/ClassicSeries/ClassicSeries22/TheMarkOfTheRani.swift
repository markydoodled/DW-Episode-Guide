...
struct TheMarkOfTheRani: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheMarkOfTheRaniClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheMarkOfTheRaniClass>
        @State var showingShare = false
        @AppStorage("TheMarkOfTheRaniNotes") var notes = ""
        @AppStorage("TheMarkOfTheRaniWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                            ...
                            Image("TheMarkOfTheRani")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheMarkOfTheRani")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheMarkOfTheRani")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Mark_of_the_Rani")!]))
                        }
                    }
                        ...
                        Image("TheMarkOfTheRani")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheMarkOfTheRani")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheMarkOfTheRani")! as UIImage)
                            } preview: {Image("TheMarkOfTheRani")}
                        Spacer()
                    }
                    Text("Story No. 139")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 139") as NSString)
                    }
                    Text("Written By - Pip And\nJane Baker")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Pip And\nJane Baker") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Mark_of_the_Rani")!], applicationActivities: nil)
                        }
                    }
...
struct TheMarkOfTheRani_Previews: PreviewProvider {
