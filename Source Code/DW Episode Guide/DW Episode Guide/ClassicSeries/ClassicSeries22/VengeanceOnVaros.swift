                            ...
                            Image("VengeanceOnVaros")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "VengeanceOnVaros")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "VengeanceOnVaros")?.tiffRepresentation
                        ...
                        Image("VengeanceOnVaros")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "VengeanceOnVaros")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "VengeanceOnVaros")! as UIImage)
                            } preview: {Image("VengeanceOnVaros")}
                        Spacer()
                    }
                    Text("Story No. 138")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 138") as NSString)
                    }
                    Text("Written By - Philip Martin")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Vengeance_on_Varos")!], applicationActivities: nil)
                        }
                    }
