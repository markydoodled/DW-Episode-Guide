...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("AttackOfTheCybermenWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("AttackOfTheCybermen")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "AttackOfTheCybermen")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "AttackOfTheCybermen")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Attack_of_the_Cybermen")!]))
                        }
                    }
                        ...
                        Image("AttackOfTheCybermen")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "AttackOfTheCybermen")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "AttackOfTheCybermen")! as UIImage)
                            } preview: {Image("AttackOfTheCybermen")}
                        Spacer()
                    }
                    Text("Story No. 137")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 137") as NSString)
                    }
                    Text("Written By - Paula Moore")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Paula Moore") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Attack_of_the_Cybermen")!], applicationActivities: nil)
                        }
                    }
