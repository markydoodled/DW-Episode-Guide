...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("ThePowerOfKrollWatched") var watched: Bool = false
    #if os(iOS)
            ...
            ScrollView {
                HStack {
                    ...
                    Image("ThePowerOfKroll")
                        ...
                        .onDrag {
                            let data = NSImage(named: "ThePowerOfKroll")?.tiffRepresentation
                        ...
                        Image("ThePowerOfKroll")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ThePowerOfKroll")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ThePowerOfKroll")! as UIImage)
                            } preview: {Image("ThePowerOfKroll")}
                        Spacer()
                    }
                    Text("Story No. 102")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 102") as NSString)
                    }
                    Text("Written By - Robert Holmes")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Power_of_Kroll")!], applicationActivities: nil)
                        }
                    }
