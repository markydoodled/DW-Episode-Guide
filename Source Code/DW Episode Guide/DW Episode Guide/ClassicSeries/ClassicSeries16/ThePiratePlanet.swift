...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("ThePiratePlanetWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("ThePiratePlanet")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "ThePiratePlanet")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "ThePiratePlanet")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Pirate_Planet")!]))
                }
            }
                        ...
                        Image("ThePiratePlanet")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ThePiratePlanet")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ThePiratePlanet")! as UIImage)
                            } preview: {Image("ThePiratePlanet")}
                        Spacer()
                    }
                    Text("Story No. 99")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 99") as NSString)
                    }
                    Text("Written By - Douglas Adams")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Douglas Adams") as NSString)
                        }
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Pirate_Planet")!], applicationActivities: nil)
                        }
                    }
