...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheAndroidsOfTaraWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheAndroidsOfTara")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheAndroidsOfTara")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheAndroidsOfTara")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Androids_of_Tara")!]))
                }
            }
                        ...
                        Image("TheAndroidsOfTara")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheAndroidsOfTara")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheAndroidsOfTara")! as UIImage)
                            } preview: {Image("TheAndroidsOfTara")}
                        Spacer()
                    }
                    Text("Story No. 101")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 101") as NSString)
                    }
                    Text("Written By - David Fisher")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - David Fisher") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Androids_of_Tara")!], applicationActivities: nil)
                        }
                    }
