...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheStonesOfBloodWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheStonesOfBlood")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheStonesOfBlood")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheStonesOfBlood")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheStonesOfBlood")
                                }) {
                    ...
                    Text("Story No. 100")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 100") as NSString)
                    }
                    Text("Written By - David Fisher")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Stones_of_Blood")!], applicationActivities: nil)
                        }
                    }
