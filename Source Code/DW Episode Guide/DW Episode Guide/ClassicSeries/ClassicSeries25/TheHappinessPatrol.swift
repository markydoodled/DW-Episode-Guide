...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheHappinessPatrolWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("TheHappinessPatrol")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheHappinessPatrol")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheHappinessPatrol")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Happiness_Patrol")!]))
                        }
                    }
                        ...
                        Image("TheHappinessPatrol")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheHappinessPatrol")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheHappinessPatrol")! as UIImage)
                            } preview: {Image("TheHappinessPatrol")}
                        Spacer()
                    }
                    Text("Story No. 149")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 149") as NSString)
                    }
                    Text("Written By - Graeme Curry")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Graeme Curry") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Happiness_Patrol")!], applicationActivities: nil)
                        }
                    }
