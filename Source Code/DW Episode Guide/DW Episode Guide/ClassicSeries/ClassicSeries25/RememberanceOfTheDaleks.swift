...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("RememberanceOfTheDaleksWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ScrollView {
                        HStack {
                            ...
                            Image("RemembranceOfTheDaleks")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "RemembranceOfTheDaleks")?.tiffRepresentation
                            ...
                            Text("Story No. 148")
                                    .font(.title3)
                                Text("Written By - Ben Aaronovitch")
                                    .font(.title3)
                        }
                            Spacer()
                        }
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Remembrance_of_the_Daleks")!]))
                        }
                    }
                        ...
                        Image("RemembranceOfTheDaleks")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "RemembranceOfTheDaleks")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "RemembranceOfTheDaleks")! as UIImage)
                            } preview: {Image("RemembranceOfTheDaleks")}
                        Spacer()
                    }
                    Text("Story No. 148")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 148") as NSString)
                    }
                    Text("Written By - Ben Aaronovitch")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Ben Aaronovitch") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Remembrance_of_the_Daleks")!], applicationActivities: nil)
                        }
                    }
