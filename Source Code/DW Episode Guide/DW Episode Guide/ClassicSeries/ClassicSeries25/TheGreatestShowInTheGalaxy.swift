...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheGreatestShowInTheGalaxyWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ScrollView {
                        HStack {
                            Spacer()
                            Image("TheGreatestShowInTheGalaxy")
                                .resizable()
                                .scaledToFill()
                                .cornerRadius(25)
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheGreatestShowInTheGalaxy")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheGreatestShowInTheGalaxy")?.tiffRepresentation
                    ...
                    .toolbar {
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Greatest_Show_in_the_Galaxy")!]))
                        }
                    }
                        ...
                        Image("TheGreatestShowInTheGalaxy")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheGreatestShowInTheGalaxy")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheGreatestShowInTheGalaxy")! as UIImage)
                            } preview: {Image("TheGrestestShowInTheGalaxy")}
                        Spacer()
                    }
                    Text("Story No. 151")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 151") as NSString)
                    }
                    Text("Written By - Stephen Wyatt")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Stephen Wyatt") as NSString)
                        }
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Greatest_Show_in_the_Galaxy")!], applicationActivities: nil)
                        }
                    }
                ...
                ScrollView {
                    HStack {
                        ...
                        Image("TheGreatestShowInTheGalaxy")
                            ...
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheGreatestShowInTheGalaxy")! as UIImage)
                            } preview: {Image("TheGreatestShowInTheGalaxy")}
                        Spacer()
                        VStack {
                        Text("\(item.title!)")
                                .bold()
