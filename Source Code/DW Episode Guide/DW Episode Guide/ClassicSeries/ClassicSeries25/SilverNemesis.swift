    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("SilverNemesis")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "SilverNemesis")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "SilverNemesis")?.tiffRepresentation
                    ...
                    .touchBar {
                        ...
                        .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Silver_Nemesis")!]))
                    }
                    .onAppear() {
                        ...
                        Image("SilverNemesis")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "SilverNemesis")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "SilverNemesis")! as UIImage)
                            } preview: {Image("SilverNemesis")}
                        Spacer()
                    }
                    Text("Story No. 150")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 150") as NSString)
                    }
                    Text("Written By - Kevin Clarke")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Kevin Clarke") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Silver_Nemesis")!], applicationActivities: nil)
                        }
                    }
