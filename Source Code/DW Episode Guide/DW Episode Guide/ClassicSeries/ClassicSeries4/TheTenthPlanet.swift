...
struct TheTenthPlanet: View {
    ...
    @AppStorage("TheTenthPlanetWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheTenthPlanet")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheTenthPlanet")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheTenthPlanet")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Tenth_Planet")!]))
                }
            }
                        ...
                        Image("TheTenthPlanet")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheTenthPlanet")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheTenthPlanet")! as UIImage)
                            } preview: {Image("TheTenthPlanet")}
                        Spacer()
                    }
                    Text("Story No. 29")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 29") as NSString)
                    }
                    Text("Written By - Kit Pedler\nAnd Gerry Davis")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Tenth_Planet")!], applicationActivities: nil)
                        }
                    }
