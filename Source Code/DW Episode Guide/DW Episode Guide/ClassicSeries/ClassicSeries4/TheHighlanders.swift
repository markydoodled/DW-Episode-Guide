...
struct TheHighlanders: View {
    ...
    @AppStorage("TheHighlandersWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheHighlanders")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheHighlanders")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheHighlanders")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Highlanders_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("TheHighlanders")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheHighlanders")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheHighlanders")! as UIImage)
                            } preview: {Image("TheHighlanders")}
                        Spacer()
                    }
                    Text("Story No. 31")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 31") as NSString)
                    }
                    Text("Written By - Elwyn Jones\nAnd Gerry Davis")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Elwyn Jones\nAnd Gerry Davis") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Highlanders_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
