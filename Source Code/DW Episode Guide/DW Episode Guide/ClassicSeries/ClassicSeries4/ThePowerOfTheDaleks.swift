...
struct ThePowerOfTheDaleks: View {
    ...
    @AppStorage("ThePowerOfTheDaleksWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("ThePowerOfTheDaleks")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "ThePowerOfTheDaleks")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "ThePowerOfTheDaleks")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Power_of_the_Daleks")!]))
                }
            }
                        ...
                        Image("ThePowerOfTheDaleks")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ThePowerOfTheDaleks")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ThePowerOfTheDaleks")! as UIImage)
                            } preview: {Image("ThePowerOfTheDaleks")}
                        Spacer()
                    }
                    Text("Story No. 30")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 30") as NSString)
                    }
                    Text("Written By - David Whitaker")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Power_of_the_Daleks")!], applicationActivities: nil)
                        }
                    }
