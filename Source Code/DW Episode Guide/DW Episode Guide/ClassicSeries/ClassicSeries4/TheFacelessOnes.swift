...
struct TheFacelessOnes: View {
    ...
    @AppStorage("TheFacelessOnesWatched") var watched: Bool = false
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheFacelessOnes")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheFacelessOnes")?.tiffRepresentation
                        ...
                        Image("TheFacelessOnes")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheFacelessOnes")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheFacelessOnes")! as UIImage)
                            } preview: {Image("TheFacelessOnes")}
                        Spacer()
                    }
                    Text("Story No. 35")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 35") as NSString)
                    }
                    Text("Written By - David Ellis\nAnd Malcolm Hulke")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - David Ellis\nAnd Malcolm Hulke") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Faceless_Ones")!], applicationActivities: nil)
                        }
                    }
