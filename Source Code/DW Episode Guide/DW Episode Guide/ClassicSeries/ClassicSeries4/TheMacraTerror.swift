...
struct TheMacraTerror: View {
    @Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheMacraTerrorClass.entity(),
            sortDescriptors: [],
            animation: .default)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheMacraTerror")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheMacraTerror")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheMacraTerror")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Macra_Terror")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheMacraTerror")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheMacraTerror")
                                }) {
                    ...
                    Text("Story No. 34")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 34") as NSString)
                    }
                    Text("Written By - Ian Stuart Black")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Ian Stuart Black") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Macra_Terror")!], applicationActivities: nil)
                        }
                    }
...
struct TheMacraTerror_Previews: PreviewProvider {
