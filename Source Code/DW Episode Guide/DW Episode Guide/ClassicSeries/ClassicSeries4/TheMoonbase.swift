        ...
        ForEach(items) { item in
                    ...
                    Image("TheMoonbase")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheMoonbase")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheMoonbase")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Moonbase")!]))
                }
            }
                        ...
                        Image("TheMoonbase")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheMoonbase")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheMoonbase")! as UIImage)
                            } preview: {Image("TheMoonbase")}
                        Spacer()
                    }
                    Text("Story No. 33")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 33") as NSString)
                    }
                    Text("Written By - Kit Pedler")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Kit Pedler") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Moonbase")!], applicationActivities: nil)
                        }
                    }
