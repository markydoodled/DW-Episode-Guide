...
struct TheUnderwaterMenace: View {
    ...
    @AppStorage("TheUnderwaterMenaceWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheUnderwaterMenace")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheUnderwaterMenace")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheUnderwaterMenace")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Underwater_Menace")!]))
                }
            }
                        ...
                        Image("TheUnderwaterMenace")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheUnderwaterMenace")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheUnderwaterMenace")! as UIImage)
                            } preview: {Image("TheUnderwaterMenace")}
                        Spacer()
                    }
                    Text("Story No. 32")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 32") as NSString)
                    }
                    Text("Written By - Geoffrey Orme")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Geoffrey Orme") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Underwater_Menace")!], applicationActivities: nil)
                        }
                    }
