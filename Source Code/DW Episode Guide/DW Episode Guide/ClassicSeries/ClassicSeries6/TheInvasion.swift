...
struct TheInvasion: View {
    ...
    @AppStorage("TheInvasionWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheInvasion")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheInvasion")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheInvasion")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Invasion_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("TheInvasion")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheInvasion")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheInvasion")! as UIImage)
                            } preview: {Image("TheInvasion")}
                        Spacer()
                    }
                    Text("Story No. 46")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 46") as NSString)
                    }
                    Text("Written By - Derrick Sherwin")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Derrick Sherwin") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Invasion_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
