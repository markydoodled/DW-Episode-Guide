...
struct TheMindRobber: View {
    ...
    @AppStorage("TheMindRobberWatched") var watched: Bool = false
    #if os(iOS)
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheMindRobber")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheMindRobber")?.tiffRepresentation
                        ...
                        Image("TheMindRobber")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheMindRobber")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheMindRobber")! as UIImage)
                            } preview: {Image("TheMindRobber")}
                        Spacer()
                    }
                    Text("Story No. 45")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 45") as NSString)
                    }
                    Text("Written By - Derrick Sherwin\nAnd Peter Ling")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Derrick Sherwin\nAnd Peter Ling") as NSString)
                        }
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Mind_Robber")!], applicationActivities: nil)
                        }
                    }
...
struct TheMindRobber_Previews: PreviewProvider {
