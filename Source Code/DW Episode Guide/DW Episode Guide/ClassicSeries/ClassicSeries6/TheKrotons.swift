...
struct TheKrotons: View {
    ...
    @AppStorage("TheKrotonsWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheKrotons")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheKrotons")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheKrotons")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Krotons")!]))
                }
            }
                        ...
                        Image("TheKrotons")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheKrotons")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheKrotons")! as UIImage)
                            } preview: {Image("TheKrotons")}
                        Spacer()
                    }
                    Text("Story No. 47")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 47") as NSString)
                    }
                    Text("Written By - Robert Holmes")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Krotons")!], applicationActivities: nil)
                        }
                    }
...
struct TheKrotons_Previews: PreviewProvider {
