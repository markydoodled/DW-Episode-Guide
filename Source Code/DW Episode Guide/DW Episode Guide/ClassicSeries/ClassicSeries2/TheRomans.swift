...
@Environment(\.managedObjectContext) private var viewContext
    ...
    @AppStorage("TheRomansWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheRomans")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheRomans")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheRomans")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Romans_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("TheRomans")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheRomans")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheRomans")! as UIImage)
                            } preview: {Image("TheRomans")}
                        Spacer()
                    }
                    Text("Story No. 12")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 12") as NSString)
                    }
                    Text("Written By - Dennis Spooner")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Romans_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
