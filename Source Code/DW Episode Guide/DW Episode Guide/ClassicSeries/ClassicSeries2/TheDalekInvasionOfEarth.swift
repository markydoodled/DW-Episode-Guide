...
@Environment(\.managedObjectContext) private var viewContext
    ...
    @AppStorage("TheDalekInvasionOfEarthWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
                    ...
                    Image("TheDalekInvasionOfEarth")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheDalekInvasionOfEarth")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheDalekInvasionOfEarth")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheDalekInvasionOfEarth")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheDalekInvasionOfEarth")
                                }) {
                    ...
                    Text("Story No. 10")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 10") as NSString)
                    }
                    Text("Written By - Terry Nation")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Dalek_Invasion_of_Earth")!], applicationActivities: nil)
                        }
                    }
