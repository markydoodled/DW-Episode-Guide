...
struct TheCurseOfPeladon: View {
    @Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheCurseOfPeladonClass.entity(),
            sortDescriptors: [],
            animation: .default)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheCurseOfPeladon")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheCurseOfPeladon")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheCurseOfPeladon")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Curse_of_Peladon")!]))
                }
            }
                        ...
                        Image("TheCurseOfPeladon")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheCurseOfPeladon")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheCurseOfPeladon")! as UIImage)
                            } preview: {Image("TheCurseOfPeladon")}
                        Spacer()
                    }
                    Text("Story No. 61")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 61") as NSString)
                    }
                    Text("Written By - Brian Hayles")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Curse_of_Peladon")!], applicationActivities: nil)
                        }
                    }
...
struct TheCurseOfPeladon_Previews: PreviewProvider {
