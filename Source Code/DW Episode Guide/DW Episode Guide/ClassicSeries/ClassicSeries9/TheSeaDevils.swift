        ...
        ForEach(items) { item in
                    ...
                    Image("TheSeaDevils")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheSeaDevils")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheSeaDevils")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Sea_Devils")!]))
                }
            }
                        ...
                        Image("TheSeaDevils")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheSeaDevils")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheSeaDevils")! as UIImage)
                            } preview: {Image("TheSeaDevils")}
                        Spacer()
                    }
                    Text("Story No. 62")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 62") as NSString)
                    }
                    Text("Written By - Malcolm Hulke")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Sea_Devils")!], applicationActivities: nil)
                        }
                    }
