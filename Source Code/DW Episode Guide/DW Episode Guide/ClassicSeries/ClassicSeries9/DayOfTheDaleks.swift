...
struct DayOfTheDaleks: View {
    ...
    @AppStorage("DayOfTheDaleksWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("DayOfTheDaleks")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "DayOfTheDaleks")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "DayOfTheDaleks")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Day_of_the_Daleks")!]))
                }
            }
                        ...
                        Image("DayOfTheDaleks")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "DayOfTheDaleks")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "DayOfTheDaleks")! as UIImage)
                            } preview: {Image("DayOfTheDaleks")}
                        Spacer()
                    }
                    Text("Story No. 60")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 60") as NSString)
                    }
                    Text("Written By - Louis Marks")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Louis Marks") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Day_of_the_Daleks")!], applicationActivities: nil)
                        }
                    }
