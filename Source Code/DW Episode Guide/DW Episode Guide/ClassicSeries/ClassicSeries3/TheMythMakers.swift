...
struct TheMythMakers: View {
    ...
    @AppStorage("TheMythMakersWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheMythMakers")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheMythMakers")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheMythMakers")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Myth_Makers")!]))
                }
            }
                        ...
                        Image("TheMythMakers")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheMythMakers")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheMythMakers")! as UIImage)
                            } preview: {Image("TheMythMakers")}
                        Spacer()
                    }
                    Text("Story No. 20")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 20") as NSString)
                    }
                    Text("Written By - Donald Cotton")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Myth_Makers")!], applicationActivities: nil)
                        }
                    }
...
struct TheMythMakers_Previews: PreviewProvider {
