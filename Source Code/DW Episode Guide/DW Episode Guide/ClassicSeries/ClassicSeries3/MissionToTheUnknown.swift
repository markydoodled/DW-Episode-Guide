...
struct MissionToTheUnknown: View {
    ...
    @AppStorage("MissionToTheUnknownWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("MissionToTheUnknown")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "MissionToTheUnknown")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "MissionToTheUnknown")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Mission_to_the_Unknown")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("MissionToTheUnknown")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "MissionToTheUnknown")
                                }) {
                    ...
                    Text("Story No. 19")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 19") as NSString)
                    }
                    Text("Written By - Terry Nation")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Mission_to_the_Unknown")!], applicationActivities: nil)
                        }
                    }
