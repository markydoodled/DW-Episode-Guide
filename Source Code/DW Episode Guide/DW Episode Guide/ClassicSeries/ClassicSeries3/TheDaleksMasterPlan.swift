...
struct TheDaleksMasterPlan: View {
    @Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheDaleksMasterPlanClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheDaleksMasterPlanClass>
        @State var showingShare = false
        @AppStorage("TheDaleksMasterPlanNotes") var notes = ""
    @AppStorage("TheDaleksMasterPlanWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheDaleksMasterPlan")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheDaleksMasterPlan")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheDaleksMasterPlan")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Daleks%27_Master_Plan")!]))
                }
            }
                        ...
                        Image("TheDaleksMasterPlan")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheDaleksMasterPlan")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheDaleksMasterPlan")! as UIImage)
                            } preview: {Image("TheDaleksMasterPlan")}
                        Spacer()
                    }
                    Text("Story No. 21")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 21") as NSString)
                    }
                    Text("Written By - Terry Nation\nAnd Dennis Spooner")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Terry Nation\nAnd Dennis Spooner") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Daleks%27_Master_Plan")!], applicationActivities: nil)
                        }
                    }
...
struct TheDaleksMasterPlan_Previews: PreviewProvider {
