    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("Galaxy4")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "Galaxy4")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "Galaxy4")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Galaxy_4")!]))
            }
            .onAppear() {
                        ...
                        Image("Galaxy4")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Galaxy4")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Galaxy4")! as UIImage)
                            } preview: {Image("Galaxy4")}
                        Spacer()
                    }
                    Text("Story No. 18")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 18") as NSString)
                    }
                    Text("Written By - William Emms")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - William Emms") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Galaxy_4")!], applicationActivities: nil)
                        }
                    }
