...
struct TheWarMachines: View {
    @Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheWarMachinesClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheWarMachinesClass>
        @State var showingShare = false
        @AppStorage("TheWarMachinesNotes") var notes = ""
    @AppStorage("TheWarMachinesWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheWarMachines")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheWarMachines")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheWarMachines")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_War_Machines")!]))
                }
            }
                ...
                Form {
                    HStack {
                        ...
                        Image("TheWarMachines")
                            ...
                            } preview: {Image("TheWarMachines")}
                        Spacer()
                    }
                    Text("Story No. 27")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 27") as NSString)
                    }
                    Text("Written By - Ian Stuart Black\nAnd Kit Pedler")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Ian Stuart Black\nAnd Kit Pedler") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_War_Machines")!], applicationActivities: nil)
                        }
                    }
...
struct TheWarMachines_Previews: PreviewProvider {
