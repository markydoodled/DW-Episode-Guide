...
struct TheCelestialToymaker: View {
    @Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheCelestialToymakerClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheCelestialToymakerClass>
        @State var showingShare = false
        @AppStorage("TheCelestialToymakerNotes") var notes = ""
    @AppStorage("TheCelestialToymakerWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheCelestialToymaker")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheCelestialToymaker")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheCelestialToymaker")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Celestial_Toymaker")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheCelestialToymaker")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheCelestialToymaker")
                                }) {
                    ...
                    Text("Story No. 24")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 24") as NSString)
                    }
                    Text("Written By - Brian Hayles")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Celestial_Toymaker")!], applicationActivities: nil)
                        }
                    }
...
struct TheCelestialToymaker_Previews: PreviewProvider {
