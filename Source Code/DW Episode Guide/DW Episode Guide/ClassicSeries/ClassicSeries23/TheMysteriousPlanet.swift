...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheMysteriousPlanetWatched") var watched: Bool = false
    #if os(iOS)
                            ...
                            Image("TheMysteriousPlanet")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheMysteriousPlanet")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheMysteriousPlanet")?.tiffRepresentation
                        ...
                        Image("TheMysteriousPlanet")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheMysteriousPlanet")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheMysteriousPlanet")! as UIImage)
                            } preview: {Image("TheMysteriousPlanet")}
                        Spacer()
                    }
                    Text("Story No. 143a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 143a") as NSString)
                    }
                    Text("Written By - Robert Holmes")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Mysterious_Planet")!], applicationActivities: nil)
                        }
                    }
