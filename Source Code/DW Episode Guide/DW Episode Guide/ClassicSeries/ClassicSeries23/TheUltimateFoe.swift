...
struct TheUltimateFoe: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheUltimateFoeClass.entity(),
            sortDescriptors: [],
            animation: .default)
        ...
        ForEach(items) { item in
                            ...
                            Image("TheUltimateFoe")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheUltimateFoe")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheUltimateFoe")?.tiffRepresentation
                    ...
                    .toolbar {
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Ultimate_Foe")!]))
                        }
                    }
                        ...
                        Image("TheUltimateFoe")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheUltimateFoe")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheUltimateFoe")! as UIImage)
                            } preview: {Image("TheUltimateFoe")}
                        Spacer()
                    }
                    Text("Story No. 143d")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 143d") as NSString)
                    }
                    Text("Written By - Robert Holmes\nAnd Pip And\nJane Baker")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Robert Holmes\nAnd Pip And\nJane Baker") as NSString)
                        }
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Ultimate_Foe")!], applicationActivities: nil)
                        }
                    }
...
struct TheUltimateFoe_Previews: PreviewProvider {
