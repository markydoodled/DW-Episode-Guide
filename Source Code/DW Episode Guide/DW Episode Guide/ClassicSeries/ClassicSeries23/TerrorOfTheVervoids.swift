...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TerrorOfTheVervoidsWatched") var watched: Bool = false
                            ...
                            Image("TerrorOfTheVervoids")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TerrorOfTheVervoids")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TerrorOfTheVervoids")?.tiffRepresentation
                        ...
                        Image("TerrorOfTheVervoids")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TerrorOfTheVervoids")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TerrorOfTheVervoids")! as UIImage)
                            } preview: {Image("TerrorOfTheVervoids")}
                        Spacer()
                    }
                    Text("Story No. 143c")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 143c") as NSString)
                    }
                    Text("Written By - Pip And\nJane Baker")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Terror_of_the_Vervoids")!], applicationActivities: nil)
                        }
                    }
