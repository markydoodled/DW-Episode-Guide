...
struct TheBrainOfMorbius: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheBrainOfMorbiusClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheBrainOfMorbiusClass>
        @State var showingShare = false
        @AppStorage("TheBrainOfMorbiusNotes") var notes = ""
        @AppStorage("TheBrainOfMorbiusWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheBrainOfMorbius")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheBrainOfMorbius")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheBrainOfMorbius")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Brain_of_Morbius")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheBrainOfMorbius")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheBrainOfMorbius")
                                }) {
                    ...
                    Text("Story No. 84")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 84") as NSString)
                    }
                    Text("Written By - 'Robin Bland' (Terrance Dicks\nRewritten By\nRobert Holmes)")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - 'Robin Bland' (Terrance Dicks\nRewritten By\nRobert Holmes)") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Brain_of_Morbius")!], applicationActivities: nil)
                        }
                    }
...
struct TheBrainOfMorbius_Previews: PreviewProvider {
