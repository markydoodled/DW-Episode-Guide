...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("PlanetOfEvilWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("PlanetOfEvil")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "PlanetOfEvil")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "PlanetOfEvil")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Planet_of_Evil")!]))
                }
            }
                        ...
                        Image("PlanetOfEvil")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "PlanetOfEvil")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "PlanetOfEvil")! as UIImage)
                            } preview: {Image("PlanetOfEvil")}
                        Spacer()
                    }
                    Text("Story No. 81")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 81") as NSString)
                    }
                    Text("Written By - Louis Marks")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Planet_of_Evil")!], applicationActivities: nil)
                        }
                    }
