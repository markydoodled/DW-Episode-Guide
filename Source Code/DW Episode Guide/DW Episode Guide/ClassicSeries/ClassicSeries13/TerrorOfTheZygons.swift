...
struct TerrorOfTheZygons: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TerrorOfTheZygonsClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TerrorOfTheZygonsClass>
        @State var showingShare = false
        @AppStorage("TerrorOfTheZygonsNotes") var notes = ""
        @AppStorage("TerrorOfTheZygonsWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TerrorOfTheZygons")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TerrorOfTheZygons")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TerrorOfTheZygons")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TerrorOfTheZygons")
                                }) {
                    ...
                    Text("Story No. 80")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 80") as NSString)
                    }
                    Text("Written By - Robert Banks Stewart")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Terror_of_the_Zygons")!], applicationActivities: nil)
                        }
                    }
...
struct TerrorOfTheZygons_Previews: PreviewProvider {
