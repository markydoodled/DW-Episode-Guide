    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheGreenDeath")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheGreenDeath")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheGreenDeath")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Green_Death")!]))
            }
            .onAppear() {
                        ...
                        Image("TheGreenDeath")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheGreenDeath")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheGreenDeath")! as UIImage)
                            } preview: {Image("TheGreenDeath")}
                        Spacer()
                    }
                    Text("Story No. 69")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 69") as NSString)
                    }
                    Text("Written By - Robert Sloman")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Green_Death")!], applicationActivities: nil)
                        }
                    }
