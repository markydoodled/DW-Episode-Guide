                    ...
                    Image("CarnivalOfMonsters")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "CarnivalOfMonsters")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "CarnivalOfMonsters")?.tiffRepresentation
                        ...
                        Image("CarnivalOfMonsters")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "CarnivalOfMonsters")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "CarnivalOfMonsters")! as UIImage)
                            } preview: {Image("CarnivalOfMonsters")}
                        Spacer()
                    }
                    Text("Story No. 66")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 66") as NSString)
                    }
                    Text("Written By - Robert Holmes")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Carnival_of_Monsters")!], applicationActivities: nil)
                        }
                    }
