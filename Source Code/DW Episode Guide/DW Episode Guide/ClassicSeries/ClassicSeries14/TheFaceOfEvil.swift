...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheFaceOfEvilWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheFaceOfEvil")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheFaceOfEvil")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheFaceOfEvil")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Face_of_Evil")!]))
                }
            }
                ...
                Form {
                    HStack {
                        ...
                        Image("TheFaceOfEvil")
                            ...
                            } preview: {Image("TheFaceOfEvil")}
                        Spacer()
                    }
                    Text("Story No. 89")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 89") as NSString)
                    }
                    Text("Written By - Chris Boucher")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Face_of_Evil")!], applicationActivities: nil)
                        }
                    }
