                    ...
                    Image("TheMasqueOfMandragora")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheMasqueOfMandragora")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheMasqueOfMandragora")?.tiffRepresentation
                        ...
                        Image("TheMasqueOfMandragora")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheMasqueOfMandragora")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheMasqueOfMandragora")! as UIImage)
                            } preview: {Image("TheMasqueOfMandragora")}
                        Spacer()
                    }
                    Text("Story No. 86")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 86") as NSString)
                    }
                    Text("Written By - Louis Marks")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Masque_of_Mandragora")!], applicationActivities: nil)
                        }
                    }
