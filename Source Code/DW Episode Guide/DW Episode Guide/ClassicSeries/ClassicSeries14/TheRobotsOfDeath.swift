...
struct TheRobotsOfDeath: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheRobotsOfDeathClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheRobotsOfDeathClass>
        @State var showingShare = false
        @AppStorage("TheRobotsOfDeathNotes") var notes = ""
        @AppStorage("TheRobotsOfDeathWatched") var watched: Bool = false
    #if os(iOS)
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheRobotsOfDeath")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheRobotsOfDeath")?.tiffRepresentation
                        ...
                        Image("TheRobotsOfDeath")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheRobotsOfDeath")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheRobotsOfDeath")! as UIImage)
                            } preview: {Image("TheRobotsOfDeath")}
                        Spacer()
                    }
                    Text("Story No. 90")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 90") as NSString)
                    }
                    Text("Written By - Chris Boucher")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Chris Boucher") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Robots_of_Death")!], applicationActivities: nil)
                        }
                    }
...
struct TheRobotsOfDeath_Previews: PreviewProvider {
