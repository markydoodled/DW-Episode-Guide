                    ...
                    Image("ImageOfTheFendahl")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "ImageOfTheFendahl")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "ImageOfTheFendahl")?.tiffRepresentation
                        ...
                        Image("ImageOfTheFendahl")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ImageOfTheFendahl")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ImageOfTheFendahl")! as UIImage)
                            } preview: {Image("ImageOfTheFendahl")}
                        Spacer()
                    }
                    Text("Story No. 94")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 94") as NSString)
                    }
                    Text("Written By - Chris Boucher")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Image_of_the_Fendahl")!], applicationActivities: nil)
                        }
                    }
