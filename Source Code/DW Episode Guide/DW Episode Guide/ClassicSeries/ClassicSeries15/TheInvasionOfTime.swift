...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheInvasionOfTimeWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheInvasionOfTime")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheInvasionOfTime")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheInvasionOfTime")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Invasion_of_Time")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheInvasionOfTime")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheInvasionOfTime")
                                }) {
                    ...
                    Text("Story No. 97")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 97") as NSString)
                    }
                    Text("Written By - 'David Agnew'\n(Graham Williams\nAnd Anthony Read)")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - 'David Agnew'\n(Graham Williams\nAnd Anthony Read)") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Invasion_of_Time")!], applicationActivities: nil)
                        }
                    }
