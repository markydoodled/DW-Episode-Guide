...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("HorrorOfFangRockWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("HorrorOfFangRock")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "HorrorOfFangRock")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "HorrorOfFangRock")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Horror_of_Fang_Rock")!]))
            }
            .onAppear() {
                        ...
                        Image("HorrorOfFangRock")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "HorrorOfFangRock")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "HorrorOfFangRock")! as UIImage)
                            } preview: {Image("HorrorOfFangRock")}
                        Spacer()
                    }
                    Text("Story No. 92")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 92") as NSString)
                    }
                    Text("Written By - Terrance Dicks")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Horror_of_Fang_Rock")!], applicationActivities: nil)
                        }
                    }
