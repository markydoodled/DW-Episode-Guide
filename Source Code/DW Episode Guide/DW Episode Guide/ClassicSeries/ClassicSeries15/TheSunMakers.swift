...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheSunMakersWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheSunMakers")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheSunMakers")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheSunMakers")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Sun_Makers")!]))
                }
            }
                        ...
                        Image("TheSunMakers")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheSunMakers")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheSunMakers")! as UIImage)
                            } preview: {Image("TheSunMakers")}
                        Spacer()
                    }
                    Text("Story No. 95")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 95") as NSString)
                    }
                    Text("Written By - Robert Holmes")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Sun_Makers")!], applicationActivities: nil)
                        }
                    }
