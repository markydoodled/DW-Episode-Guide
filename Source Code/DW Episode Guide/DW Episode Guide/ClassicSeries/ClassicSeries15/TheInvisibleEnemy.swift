...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheInvisibleEnemyWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheInvisibleEnemy")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheInvisibleEnemy")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheInvisibleEnemy")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Invisible_Enemy_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("TheInvisibleEnemy")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheInvisibleEnemy")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheInvisibleEnemy")! as UIImage)
                            } preview: {Image("TheInvisibleEnemy")}
                        Spacer()
                    }
                    Text("Story No. 93")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 93") as NSString)
                    }
                    Text("Written By - Bob Baker\nAnd Dave Martin")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Invisible_Enemy_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
