...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @FetchRequest(entity: FlatlineClass.entity(),
            sortDescriptors: [],
            animation: .default)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("Flatline")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "Flatline")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "Flatline")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Flatline_(Doctor_Who)")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("Flatline")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Flatline")
                                }) {
                    ...
                    Text("Story No. 250")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 250") as NSString)
                    }
                    Text("Written By - Jamie Mathieson")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Flatline_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
...
struct Flatline_Previews: PreviewProvider {
