...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("InTheForestOfTheNightWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("InTheForestOfTheNight")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "InTheForestOfTheNight")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "InTheForestOfTheNight")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/In_the_Forest_of_the_Night")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("InTheForestOfTheNight")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "InTheForestOfTheNight")
                                }) {
                    ...
                    Text("Story No. 251")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 251") as NSString)
                    }
                    Text("Written By - Frank Cottrell-Boyce")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Frank Cottrell-Boyce") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/In_the_Forest_of_the_Night")!], applicationActivities: nil)
                        }
                    }
