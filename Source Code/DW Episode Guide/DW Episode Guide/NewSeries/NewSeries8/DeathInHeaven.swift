...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("DeathInHeavenWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("DeathInHeaven")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "DeathInHeaven")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "DeathInHeaven")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Death_in_Heaven")!]))
                }
            }
                        ...
                        Image("DeathInHeaven")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "DeathInHeaven")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "DeathInHeaven")! as UIImage)
                            } preview: {Image("DeathInHeaven")}
                        Spacer()
                    }
                    Text("Story No. 252b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 252b") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Death_in_Heaven")!], applicationActivities: nil)
                        }
                    }
