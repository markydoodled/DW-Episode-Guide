            ...
            ScrollView {
                HStack {
                    ...
                    Image("IntoTheDalek")
                        ...
                        .onDrag {
                            let data = NSImage(named: "IntoTheDalek")?.tiffRepresentation
                        ...
                        Image("IntoTheDalek")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "IntoTheDalek")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "IntoTheDalek")! as UIImage)
                            } preview: {Image("IntoTheDalek")}
                        Spacer()
                    }
                    Text("Story No. 243")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 243") as NSString)
                    }
                    Text("Written By - Phil Ford\nAnd Steven Moffat")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Phil Ford\nAnd Steven Moffat") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Into_the_Dalek")!], applicationActivities: nil)
                        }
                    }
