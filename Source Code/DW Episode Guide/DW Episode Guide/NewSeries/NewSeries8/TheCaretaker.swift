        ...
        ForEach(items) { item in
                    ...
                    Image("TheCaretaker")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheCaretaker")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheCaretaker")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Caretaker_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("TheCaretaker")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheCaretaker")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheCaretaker")! as UIImage)
                            } preview: {Image("TheCaretaker")}
                        Spacer()
                    }
                    Text("Story No. 247")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 247") as NSString)
                    }
                    Text("Written By - Gareth Roberts\nAnd Steven Moffat")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Gareth Roberts\nAnd Steven Moffat") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Caretaker_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
