...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("MummyOnTheOrientExpressWatched") var watched: Bool = false
                    ...
                    Image("MummyOnTheOrientExpress")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "MummyOnTheOrientExpress")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "MummyOnTheOrientExpress")?.tiffRepresentation
                        ...
                        Image("MummyOnTheOrientExpress")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "MummyOnTheOrientExpress")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "MummyOnTheOrientExpress")! as UIImage)
                            } preview: {Image("MummyOnTheOrientExpress")}
                        Spacer()
                    }
                    Text("Story No. 249")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 249") as NSString)
                    }
                    Text("Written By - Jamie Mathieson")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Jamie Mathieson") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Mummy_on_the_Orient_Express")!], applicationActivities: nil)
                        }
                    }
