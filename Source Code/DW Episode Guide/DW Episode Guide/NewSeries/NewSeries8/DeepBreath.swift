    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("DeepBreath")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "DeepBreath")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "DeepBreath")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Deep_Breath_(Doctor_Who)")!]))
            }
            .onAppear() {
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("DeepBreath")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "DeepBreath")
                                }) {
                    ...
                    Text("Story No. 242")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 242") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Deep_Breath_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
