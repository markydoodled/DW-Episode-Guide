...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("RobotOfSherwoodWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("RobotOfSherwood")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "RobotOfSherwood")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "RobotOfSherwood")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Robot_of_Sherwood")!]))
                }
            }
                        ...
                        Image("RobotOfSherwood")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "RobotOfSherwood")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "RobotOfSherwood")! as UIImage)
                            } preview: {Image("RobotOfSherwood")}
                        Spacer()
                    }
                    Text("Story No. 244")
                    .onDrag {
