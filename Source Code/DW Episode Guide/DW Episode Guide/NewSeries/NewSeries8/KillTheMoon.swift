...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("KillTheMoonWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("KillTheMoon")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "KillTheMoon")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "KillTheMoon")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Kill_the_Moon")!]))
                }
            }
                        ...
                        Image("KillTheMoon")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "KillTheMoon")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "KillTheMoon")! as UIImage)
                            } preview: {Image("KillTheMoon")}
                        Spacer()
                    }
                    Text("Story No. 248")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 248") as NSString)
                    }
                    Text("Written By - Peter Harness")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Peter Harness") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Kill_the_Moon")!], applicationActivities: nil)
                        }
                    }
