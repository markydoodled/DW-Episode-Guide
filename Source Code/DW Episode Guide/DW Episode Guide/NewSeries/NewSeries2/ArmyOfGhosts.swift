...
struct ArmyOfGhosts: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: ArmyOfGhostsClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<ArmyOfGhostsClass>
        @State var showingShare = false
        @AppStorage("ArmyOfGhostsNotes") var notes = ""
        @AppStorage("ArmyOfGhostsWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                            ...
                            Image("ArmyOfGhosts")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "ArmyOfGhosts")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "ArmyOfGhosts")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Army_of_Ghosts")!]))
                        }
                    }
                        ...
                        Image("ArmyOfGhosts")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ArmyOfGhosts")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ArmyOfGhosts")! as UIImage)
                            } preview: {Image("ArmyOfGhosts")}
                        Spacer()
                    }
                    Text("Story No. 177a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 177a") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Army_of_Ghosts")!], applicationActivities: nil)
                        }
                    }
...
struct ArmyOfGhosts_Previews: PreviewProvider {
