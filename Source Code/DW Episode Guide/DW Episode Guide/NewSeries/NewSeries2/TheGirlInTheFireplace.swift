...
struct TheGirlInTheFireplace: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheGirlInTheFireplaceClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheGirlInTheFireplaceClass>
        @State var showingShare = false
        @AppStorage("TheGirlInTheFireplaceNotes") var notes = ""
        @AppStorage("TheGirlInTheFireplaceWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                            ...
                            Image("TheGirlInTheFireplace")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheGirlInTheFireplace")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheGirlInTheFireplace")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Girl_in_the_Fireplace")!]))
                        }
                    }
                        ...
                        Image("TheGirlInTheFireplace")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheGirlInTheFireplace")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheGirlInTheFireplace")! as UIImage)
                            } preview: {Image("TheGirlInTheFireplace")}
                        Spacer()
                    }
                    Text("Story No. 171")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 171") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Girl_in_the_Fireplace")!], applicationActivities: nil)
                        }
                    }
...
struct TheGirlInTheFireplace_Previews: PreviewProvider {
