...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("LoveAndMonstersWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ScrollView {
                        HStack {
                            ...
                            Image("Love&Monsters")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "Love&Monsters")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Love_%26_Monsters")!]))
                        }
                    }
                        ...
                        Image("Love&Monsters")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Love&Monsters")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Love&Monsters")! as UIImage)
                            } preview: {Image("Love&Monsters")}
                        Spacer()
                    }
                    Text("Story No. 175")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 175") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Love_%26_Monsters")!], applicationActivities: nil)
                        }
                    }
