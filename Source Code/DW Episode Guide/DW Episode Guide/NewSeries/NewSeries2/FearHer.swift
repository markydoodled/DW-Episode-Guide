...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @FetchRequest(entity: FearHerClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<FearHerClass>
        @State var showingShare = false
        @AppStorage("FearHerNotes") var notes = ""
        @AppStorage("FearHerWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("FearHer")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "FearHer")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "FearHer")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Fear_Her")!]))
                        }
                    }
                        ...
                        Image("FearHer")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "FearHer")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "FearHer")! as UIImage)
                            } preview: {Image("FearHer")}
                        Spacer()
                    }
                    Text("Story No. 176")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 176") as NSString)
                    }
                    Text("Written By - Matthew Graham")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Fear_Her")!], applicationActivities: nil)
                        }
                    }
...
struct FearHer_Previews: PreviewProvider {
