...
struct TheAgeOfSteel: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheAgeOfSteelClass.entity(),
            sortDescriptors: [],
            animation: .default)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("TheAgeOfSteel")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheAgeOfSteel")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheAgeOfSteel")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Age_of_Steel")!]))
                        }
                    }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheAgeOfSteel")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheAgeOfSteel")
                                }) {
                    ...
                    Text("Story No. 172b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 172b") as NSString)
                    }
                    Text("Written By - Tom MacRae")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Age_of_Steel")!], applicationActivities: nil)
                        }
                    }
...
struct TheAgeOfSteel_Previews: PreviewProvider {
