        ...
        ForEach(items) { item in
                            ...
                            Image("ToothAndClaw")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "ToothAndClaw")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "ToothAndClaw")?.tiffRepresentation
                    ...
                    .toolbar {
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Tooth_and_Claw_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("ToothAndClaw")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ToothAndClaw")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ToothAndClaw")! as UIImage)
                            } preview: {Image("ToothAndClaw")}
                        Spacer()
                    }
                    Text("Story No. 169")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 169") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Tooth_and_Claw_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
