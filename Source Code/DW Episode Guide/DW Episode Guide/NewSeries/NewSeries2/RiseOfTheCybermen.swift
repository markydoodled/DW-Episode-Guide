...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("RiseOfTheCybermenWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("RiseOfTheCybermen")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "RiseOfTheCybermen")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "RiseOfTheCybermen")?.tiffRepresentation
                    ...
                    .touchBar {
                        ...
                        .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Rise_of_the_Cybermen")!]))
                    }
                    .onAppear() {
                        ...
                        Image("RiseOfTheCybermen")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "RiseOfTheCybermen")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "RiseOfTheCybermen")! as UIImage)
                            } preview: {Image("RiseOfTheCybermen")}
                        Spacer()
                    }
                    Text("Story No. 172a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 172a") as NSString)
                    }
                    Text("Written By - Tom MacRae")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Rise_of_the_Cybermen")!], applicationActivities: nil)
                        }
                    }
