...
struct SchoolReunion: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: SchoolReunionClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<SchoolReunionClass>
        ...
        ForEach(items) { item in
                            ...
                            Image("SchoolReunion")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "SchoolReunion")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "SchoolReunion")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/School_Reunion_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("SchoolReunion")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "SchoolReunion")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "SchoolReunion")! as UIImage)
                            } preview: {Image("SchoolReunion")}
                        Spacer()
                    }
                    Text("Story No. 170")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 170") as NSString)
                    }
                    Text("Written By - Toby Whithouse")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/School_Reunion_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
...
struct SchoolReunion_Previews: PreviewProvider {
