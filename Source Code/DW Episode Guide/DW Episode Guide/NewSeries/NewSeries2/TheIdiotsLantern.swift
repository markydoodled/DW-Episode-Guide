...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheIdiotsLanternWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("TheIdiotsLantern")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheIdiotsLantern")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheIdiotsLantern")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Idiot%27s_Lantern")!]))
                        }
                    }
                        ...
                        Image("TheIdiotsLantern")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheIdiotsLantern")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheIdiotsLantern")! as UIImage)
                            } preview: {Image("TheIdiotsLantern")}
                        Spacer()
                    }
                    Text("Story No. 173")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 173") as NSString)
                    }
                    Text("Written By - Mark Gatiss")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Idiot%27s_Lantern")!], applicationActivities: nil)
                        }
                    }
