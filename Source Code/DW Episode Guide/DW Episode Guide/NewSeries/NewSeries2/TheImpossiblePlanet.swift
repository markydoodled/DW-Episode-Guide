...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheImpossiblePlanetWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                            ...
                            Image("TheImpossiblePlanet")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheImpossiblePlanet")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheImpossiblePlanet")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Impossible_Planet")!]))
                        }
                    }
                        ...
                        Image("TheImpossiblePlanet")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheImpossiblePlanet")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheImpossiblePlanet")! as UIImage)
                            } preview: {Image("TheImpossiblePlanet")}
                        Spacer()
                    }
                    Text("Story No. 174a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 174a") as NSString)
                    }
                    Text("Written By - Matt Jones")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Matt Jones") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Impossible_Planet")!], applicationActivities: nil)
                        }
                    }
