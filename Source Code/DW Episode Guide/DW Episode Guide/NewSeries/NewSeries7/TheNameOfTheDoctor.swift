...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheNameOfTheDoctorWatched") var watched: Bool = false
    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheNameOfTheDoctor")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheNameOfTheDoctor")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheNameOfTheDoctor")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheNameOfTheDoctor")
                                }) {
                    ...
                    Text("Story No. 239")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 239") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Name_of_the_Doctor")!], applicationActivities: nil)
                        }
                    }
