...
struct TheSnowmen: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheSnowmenClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheSnowmenClass>
        @State var showingShare = false
        @AppStorage("TheSnowmenNotes") var notes = ""
        @AppStorage("TheSnowmenWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheSnowmen")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheSnowmen")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheSnowmen")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Snowmen")!]))
                }
            }
                        ...
                        Image("TheSnowmen")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheSnowmen")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheSnowmen")! as UIImage)
                            } preview: {Image("TheSnowmen")}
                        Spacer()
                    }
                    Text("Story No. 231")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 231") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Snowmen")!], applicationActivities: nil)
                        }
                    }
...
struct TheSnowmen_Previews: PreviewProvider {
