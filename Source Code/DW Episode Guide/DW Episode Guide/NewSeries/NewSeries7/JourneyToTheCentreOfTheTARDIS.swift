    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("JourneyToTheCentreOfTheTARDIS")
                        ...
                        .onDrag {
                            let data = NSImage(named: "JourneyToTheCentreOfTheTARDIS")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("JourneyToTheCentreOfTheTARDIS")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "JourneyToTheCentreOfTheTARDIS")
                                }) {
                    ...
                    Text("Story No. 236")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 236") as NSString)
                    }
                    Text("Written By - Stephen Thompson")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Journey_to_the_Centre_of_the_TARDIS")!], applicationActivities: nil)
                        }
                    }
