...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("ThePowerOfThreeWatched") var watched: Bool = false
    #if os(iOS)
                    ...
                    Image("ThePowerOfThree")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "ThePowerOfThree")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "ThePowerOfThree")?.tiffRepresentation
                        ...
                        Image("ThePowerOfThree")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ThePowerOfThree")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ThePowerOfThree")! as UIImage)
                            } preview: {Image("ThePowerOfThree")}
                        Spacer()
                    }
                    Text("Story No. 229")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 229") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Power_of_Three_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
