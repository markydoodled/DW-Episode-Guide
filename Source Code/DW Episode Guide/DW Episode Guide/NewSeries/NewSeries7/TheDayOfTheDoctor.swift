...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheDayOfTheDoctorWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheDayOfTheDoctor")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheDayOfTheDoctor")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheDayOfTheDoctor")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Day_of_the_Doctor")!]))
                }
            }
                        ...
                        Image("TheDayOfTheDoctor")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheDayOfTheDoctor")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheDayOfTheDoctor")! as UIImage)
                            } preview: {Image("TheDayOfTheDoctor")}
                        Spacer()
                    }
                    Text("Story No. 240")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 240") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Day_of_the_Doctor")!], applicationActivities: nil)
                        }
                    }
