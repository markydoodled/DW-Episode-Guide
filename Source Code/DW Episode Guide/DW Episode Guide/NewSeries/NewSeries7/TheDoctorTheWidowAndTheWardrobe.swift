//
//  TheDoctorTheWidowAndTheWardrobe.swift
//  DW Episode Guide
//
...
struct TheDoctorTheWidowAndTheWardrobe: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheDoctorTheWidowAndTheWardrobeClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheDoctorTheWidowAndTheWardrobeClass>
        @State var showingShare = false
        @AppStorage("TheDoctorTheWidowAndTheWardrobeNotes") var notes = ""
        @AppStorage("TheDoctorTheWidowAndTheWardrobeWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
            ScrollView {
                HStack {
                    Spacer()
                    Image("TheDoctorTheWidowAndTheWardrobe")
                        .resizable()
                        .scaledToFill()
                        .cornerRadius(25)
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheDoctorTheWidowAndTheWardrobe")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheDoctorTheWidowAndTheWardrobe")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Doctor,_the_Widow_and_the_Wardrobe")!]))
                }
            }
                        ...
                        Image("TheDoctorTheWidowAndTheWardrobe")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheDoctorTheWidowAndTheWardrobe")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheDoctorTheWidowAndTheWardrobe")! as UIImage)
                            } preview: {Image("TheDoctorTheWidowAndTheWardrobe")}
                        Spacer()
                    }
                    Text("Story No. 225")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 225") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Doctor,_the_Widow_and_the_Wardrobe")!], applicationActivities: nil)
                        }
                    }
...
struct TheDoctorTheWidowAndTheWardrobe_Previews: PreviewProvider {
