...
struct TheTimeOfTheDoctor: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheTimeOfTheDoctorClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheTimeOfTheDoctorClass>
        @State var showingShare = false
        @AppStorage("TheTimeOfTheDoctorNotes") var notes = ""
        @AppStorage("TheTimeOfTheDoctorWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheTimeOfTheDoctor")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheTimeOfTheDoctor")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheTimeOfTheDoctor")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Time_of_the_Doctor")!]))
                }
            }
                        ...
                        Image("TheTimeOfTheDoctor")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheTimeOfTheDoctor")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheTimeOfTheDoctor")! as UIImage)
                            } preview: {Image("TheTimeOfTheDoctor")}
                        Spacer()
                    }
                    Text("Story No. 241")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 241") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Time_of_the_Doctor")!], applicationActivities: nil)
                        }
                    }
...
struct TheTimeOfTheDoctor_Previews: PreviewProvider {
