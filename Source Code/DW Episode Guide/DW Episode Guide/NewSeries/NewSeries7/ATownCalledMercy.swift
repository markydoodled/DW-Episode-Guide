...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("ATownCalledMercyWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("ATownCalledMercy")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "ATownCalledMercy")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "ATownCalledMercy")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/A_Town_Called_Mercy")!]))
                }
            }
                        ...
                        Image("ATownCalledMercy")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ATownCalledMercy")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ATownCalledMercy")! as UIImage)
                            } preview: {Image("ATownCalledMercy")}
                        Spacer()
                    }
                    Text("Story No. 228")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 228") as NSString)
                    }
                    Text("Written By - Toby Whithouse")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/A_Town_Called_Mercy")!], applicationActivities: nil)
                        }
                    }
