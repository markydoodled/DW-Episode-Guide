...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheCrimsonHorrorWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheCrimsonHorror")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheCrimsonHorror")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheCrimsonHorror")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Crimson_Horror")!]))
            }
            .onAppear() {
                        ...
                        Image("TheCrimsonHorror")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheCrimsonHorror")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheCrimsonHorror")! as UIImage)
                            } preview: {Image("TheCrimsonHorror")}
                        Spacer()
                    }
                    Text("Story No. 237")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 237") as NSString)
                    }
                    Text("Written By - Mark Gatiss")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Crimson_Horror")!], applicationActivities: nil)
                        }
                    }
...
struct TheCrimsonHorror_Previews: PreviewProvider {
