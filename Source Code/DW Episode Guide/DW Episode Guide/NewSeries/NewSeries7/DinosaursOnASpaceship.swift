...
struct DinosaursOnASpaceship: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: DinosaursOnASpaceshipClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<DinosaursOnASpaceshipClass>
        @State var showingShare = false
        @AppStorage("DinosaursOnASpaceshipNotes") var notes = ""
        @AppStorage("DinosaursOnASpaceshipWatched") var watched: Bool = false
                    ...
                    Image("DinosaursOnASpaceship")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "DinosaursOnASpaceship")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "DinosaursOnASpaceship")?.tiffRepresentation
                ...
                Form {
                    HStack {
                        ...
                        Image("DinosaursOnASpaceship")
                            ...
                            } preview: {Image("DinosaursOnASpaceship")}
                        Spacer()
                    }
                    Text("Story No. 227")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 227") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Dinosaurs_on_a_Spaceship")!], applicationActivities: nil)
                        }
                    }
...
struct DinosaursOnASpaceship_Previews: PreviewProvider {
