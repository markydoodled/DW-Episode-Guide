...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("NightmareInSilverWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("NightmareInSilver")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "NightmareInSilver")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "NightmareInSilver")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Nightmare_in_Silver")!]))
                }
            }
                        ...
                        Image("NightmareInSilver")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "NightmareInSilver")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "NightmareInSilver")! as UIImage)
                            } preview: {Image("NightmareInSilver")}
                        Spacer()
                    }
                    Text("Story No. 238")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 238") as NSString)
                    }
                    Text("Written By - Neil Gaiman")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Neil Gaiman") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Nightmare_in_Silver")!], applicationActivities: nil)
                        }
                    }
