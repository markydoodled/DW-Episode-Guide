...
struct TheRingsOfAkhaten: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheRingsOfAkhatenClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheRingsOfAkhatenClass>
        @State var showingShare = false
        @AppStorage("TheRingsOfAkhatenNotes") var notes = ""
        @AppStorage("TheRingsOfAkhatenWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheRingsOfAkhaten")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheRingsOfAkhaten")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheRingsOfAkhaten")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Rings_of_Akhaten")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheRingsOfAkhaten")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheRingsOfAkhaten")
                                }) {
                    ...
                    Text("Story No. 233")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 233") as NSString)
                    }
                    Text("Written By - Neil Cross")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Neil Cross") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Rings_of_Akhaten")!], applicationActivities: nil)
                        }
                    }
...
struct TheRingsOfAkhaten_Previews: PreviewProvider {
