...
struct ThePandoricaOpens: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: ThePandoricaOpensClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<ThePandoricaOpensClass>
        @State var showingShare = false
        @AppStorage("ThePandoricaOpensNotes") var notes = ""
        @AppStorage("ThePandoricaOpensWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                            ...
                            Image("ThePandoricaOpens")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "ThePandoricaOpens")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "ThePandoricaOpens")?.tiffRepresentation
                    ...
                    .toolbar {
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Pandorica_Opens")!]))
                        }
                    }
                        ...
                        Image("ThePandoricaOpens")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ThePandoricaOpens")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ThePandoricaOpens")! as UIImage)
                            } preview: {Image("ThePandoricaOpens")}
                        Spacer()
                    }
                    Text("Story No. 212a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 212a") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Pandorica_Opens")!], applicationActivities: nil)
                        }
                    }
...
struct ThePandoricaOpens_Previews: PreviewProvider {
