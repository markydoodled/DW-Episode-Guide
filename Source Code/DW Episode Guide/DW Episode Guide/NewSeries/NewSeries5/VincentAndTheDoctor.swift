...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("VincentAndTheDoctorWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("VincentAndTheDoctor")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "VincentAndTheDoctor")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                    ...
                    .touchBar {
                        ...
                        .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Vincent_and_the_Doctor")!]))
                    }
                    .onAppear() {
                        ...
                        Image("VincentAndTheDoctor")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "VincentAndTheDoctor")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "VincentAndTheDoctor")! as UIImage)
                            } preview: {Image("VincentAndTheDoctor")}
                        Spacer()
                    }
                    Text("Story No. 210")
                    .onDrag {
