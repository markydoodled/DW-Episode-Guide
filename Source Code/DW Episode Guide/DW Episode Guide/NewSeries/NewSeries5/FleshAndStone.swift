                    ...
                    ScrollView {
                        HStack {
                            ...
                            Image("FleshAndStone")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "FleshAndStone")?.tiffRepresentation
                        ...
                        Image("FleshAndStone")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "FleshAndStone")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "FleshAndStone")! as UIImage)
                            } preview: {Image("FleshAndStone")}
                        Spacer()
                    }
                    Text("Story No. 206b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 206b") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Flesh_and_Stone")!], applicationActivities: nil)
                        }
                    }
