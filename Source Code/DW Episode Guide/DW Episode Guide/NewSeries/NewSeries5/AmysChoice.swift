        ...
        ForEach(items) { item in
                            ...
                            Image("AmysChoice")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "AmysChoice")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "AmysChoice")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Amy%27s_Choice_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("AmysChoice")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "AmysChoice")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "AmysChoice")! as UIImage)
                            } preview: {Image("AmysChoice")}
                        Spacer()
                    }
                    Text("Story No. 208")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 208") as NSString)
                    }
                    Text("Written By - Simon Nye")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Simon Nye") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Amy%27s_Choice_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
