...
struct TheHungryEarth: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheHungryEarthClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheHungryEarthClass>
        @State var showingShare = false
        @AppStorage("TheHungryEarthNotes") var notes = ""
        @AppStorage("TheHungryEarthWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("TheHungryEarth")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheHungryEarth")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheHungryEarth")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Hungry_Earth")!]))
                        }
                    }
                        ...
                        Image("TheHungryEarth")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheHungryEarth")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheHungryEarth")! as UIImage)
                            } preview: {Image("TheHungryEarth")}
                        Spacer()
                    }
                    Text("Story No. 209a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 209a") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Hungry_Earth")!], applicationActivities: nil)
                        }
                    }
...
struct TheHungryEarth_Previews: PreviewProvider {
