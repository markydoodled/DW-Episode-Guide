        ...
        ForEach(items) { item in
                            ...
                            Image("TheLodger")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheLodger")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheLodger")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Lodger_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("TheLodger")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheLodger")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheLodger")! as UIImage)
                            } preview: {Image("TheLodger")}
                        Spacer()
                    }
                    Text("Story No. 211")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 211") as NSString)
                    }
                    Text("Written By - Gareth Roberts")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Lodger_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
