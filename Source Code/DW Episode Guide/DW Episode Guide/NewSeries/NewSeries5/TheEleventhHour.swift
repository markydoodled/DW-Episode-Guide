...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheEleventhHourWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("TheEleventhHour")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheEleventhHour")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheEleventhHour")?.tiffRepresentation
                    ...
                    .touchBar {
                        ...
                        .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Eleventh_Hour_(Doctor_Who)")!]))
                    }
                    .onAppear() {
                        ...
                        Image("TheEleventhHour")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheEleventhHour")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheEleventhHour")! as UIImage)
                            } preview: {Image("TheEleventhHour")}
                        Spacer()
                    }
                    Text("Story No. 203")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 203") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Eleventh_Hour_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
