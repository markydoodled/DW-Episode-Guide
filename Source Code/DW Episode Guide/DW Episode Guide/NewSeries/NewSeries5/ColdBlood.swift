                    ...
                    ScrollView {
                        HStack {
                            ...
                            Image("ColdBlood")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "ColdBlood")?.tiffRepresentation
                        ...
                        Image("ColdBlood")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ColdBlood")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ColdBlood")! as UIImage)
                            } preview: {Image("ColdBlood")}
                        Spacer()
                    }
                    Text("Story No. 209b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 209b") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Cold_Blood_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
