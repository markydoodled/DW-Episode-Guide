...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheUnquietDeadWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("TheUnquietDead")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheUnquietDead")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheUnquietDead")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Unquiet_Dead")!]))
                        }
                    }
                        ...
                        Image("TheUnquietDead")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheUnquietDead")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheUnquietDead")! as UIImage)
                            } preview: {Image("TheUnquietDead")}
                        Spacer()
                    }
                    Text("Story No. 159")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 159") as NSString)
                    }
                    Text("Written By - Mark Gatiss")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Unquiet_Dead")!], applicationActivities: nil)
                        }
                    }
