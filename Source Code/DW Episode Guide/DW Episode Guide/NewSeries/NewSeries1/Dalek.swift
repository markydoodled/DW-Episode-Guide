...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("DalekWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ScrollView {
                        HStack {
                            ...
                            Image("Dalek")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "Dalek")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "Dalek")?.tiffRepresentation
                            ...
                            Text("Story No. 161")
                                    .font(.title3)
                                Text("Written By - Robert Shearman")
                                    .font(.title3)
                        }
                            Spacer()
                        }
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Dalek_(Doctor_Who_episode)")!]))
                        }
                    }
                        ...
                        Image("Dalek")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Dalek")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Dalek")! as UIImage)
                            } preview: {Image("Dalek")}
                        Spacer()
                    }
                    Text("Story No. 161")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 161") as NSString)
                    }
                    Text("Written By - Robert Shearman")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Robert Shearman") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Dalek_(Doctor_Who_episode)")!], applicationActivities: nil)
                        }
                    }
