...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheEndOfTheWorldWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                            ...
                            Image("TheEndOfTheWorld")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheEndOfTheWorld")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheEndOfTheWorld")?.tiffRepresentation
                    ...
                    .toolbar {
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_End_of_the_World_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("TheEndOfTheWorld")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheEndOfTheWorld")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheEndOfTheWorld")! as UIImage)
                            } preview: {Image("TheEndOfTheWorld")}
                        Spacer()
                    }
                    Text("Story No. 158")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 158") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_End_of_the_World_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
