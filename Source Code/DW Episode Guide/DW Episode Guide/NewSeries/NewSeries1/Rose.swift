                    ...
                    ScrollView {
                        HStack {
                            ...
                            Image("Rose")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "Rose")?.tiffRepresentation
                        ...
                        Image("Rose")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Rose")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Rose")! as UIImage)
                            } preview: {Image("Rose")}
                        Spacer()
                    }
                    Text("Story No. 157")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 157") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Rose_(Doctor_Who_episode)")!], applicationActivities: nil)
                        }
                    }
