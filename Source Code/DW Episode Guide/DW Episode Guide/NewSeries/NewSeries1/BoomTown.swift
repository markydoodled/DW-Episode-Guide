                    ...
                    ScrollView {
                        HStack {
                            ...
                            Image("BoomTown")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "BoomTown")?.tiffRepresentation
                        ...
                        Image("BoomTown")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "BoomTown")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "BoomTown")! as UIImage)
                            } preview: {Image("BoomTown")}
                        Spacer()
                    }
                    Text("Story No. 165")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 165") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Boom_Town_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
