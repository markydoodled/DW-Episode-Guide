...
struct WorldWarThree: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: WorldWarThreeClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<WorldWarThreeClass>
        @State var showingShare = false
        @AppStorage("WorldWarThreeNotes") var notes = ""
        @AppStorage("WorldWarThreeWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("WorldWarThree")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "WorldWarThree")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "WorldWarThree")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/World_War_Three_(Doctor_Who)")!]))
                        }
                    }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("WorldWarThree")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "WorldWarThree")
                                }) {
                    ...
                    Text("Story No. 160b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 160b") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/World_War_Three_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
...
struct WorldWarThree_Previews: PreviewProvider {
