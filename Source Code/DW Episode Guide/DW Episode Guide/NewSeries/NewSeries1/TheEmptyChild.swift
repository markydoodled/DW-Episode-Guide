                        ...
                        Image("TheEmptyChild")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheEmptyChild")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheEmptyChild")! as UIImage)
                            } preview: {Image("TheEmptyChild")}
                        Spacer()
                    }
                    Text("Story No. 164a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 164a") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Empty_Child")!], applicationActivities: nil)
                        }
                    }
