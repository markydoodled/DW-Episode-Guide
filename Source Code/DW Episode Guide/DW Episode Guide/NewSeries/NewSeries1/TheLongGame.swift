...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheLongGameWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("TheLongGame")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheLongGame")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheLongGame")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Long_Game")!]))
                        }
                    }
                        ...
                        Image("TheLongGame")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheLongGame")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheLongGame")! as UIImage)
                            } preview: {Image("TheLongGame")}
                        Spacer()
                    }
                    Text("Story No. 162")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 162") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Long_Game")!], applicationActivities: nil)
                        }
                    }
