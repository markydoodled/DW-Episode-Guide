    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("FathersDay")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "FathersDay")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "FathersDay")?.tiffRepresentation
                    ...
                    .touchBar {
                        ...
                        .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Father%27s_Day_(Doctor_Who)")!]))
                    }
                    .onAppear() {
                        ...
                        Image("FathersDay")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "FathersDay")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "FathersDay")! as UIImage)
                            } preview: {Image("FathersDay")}
                        Spacer()
                    }
                    Text("Story No. 163")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 163") as NSString)
                    }
                    Text("Written By - Paul Cornell")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Paul Cornell") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Father%27s_Day_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
