                    ...
                    ScrollView {
                        HStack {
                            ...
                            Image("BadWolf")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "BadWolf")?.tiffRepresentation
                        ...
                        Image("BadWolf")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "BadWolf")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "BadWolf")! as UIImage)
                            } preview: {Image("BadWolf")}
                        Spacer()
                    }
                    Text("Story No. 166a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 166a") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Bad_Wolf")!], applicationActivities: nil)
                        }
                    }
