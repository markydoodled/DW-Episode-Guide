...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheGirlWhoWaitedWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheGirlWhoWaited")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheGirlWhoWaited")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheGirlWhoWaited")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Girl_Who_Waited")!]))
                }
            }
                        ...
                        Image("TheGirlWhoWaited")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheGirlWhoWaited")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheGirlWhoWaited")! as UIImage)
                            } preview: {Image("TheGirlWhoWaited")}
                        Spacer()
                    }
                    Text("Story No. 221")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 221") as NSString)
                    }
                    Text("Written By - Tom MacRae")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Tom MacRae") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Girl_Who_Waited")!], applicationActivities: nil)
                        }
                    }
