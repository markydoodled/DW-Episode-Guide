...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("NightTerrorsWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("NightTerrors")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "NightTerrors")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "NightTerrors")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Night_Terrors_(Doctor_Who)")!]))
            }
            .onAppear() {
                        ...
                        Image("NightTerrors")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "NightTerrors")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "NightTerrors")! as UIImage)
                            } preview: {Image("NightTerrors")}
                        Spacer()
                    }
                    Text("Story No. 220")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 220") as NSString)
                    }
                    Text("Written By - Mark Gatiss")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Night_Terrors_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
