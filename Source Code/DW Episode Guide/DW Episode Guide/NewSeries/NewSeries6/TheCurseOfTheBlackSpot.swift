    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheCurseOfTheBlackSpot")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheCurseOfTheBlackSpot")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheCurseOfTheBlackSpot")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Curse_of_the_Black_Spot")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheCurseOfTheBlackSpot")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheCurseOfTheBlackSpot")
                                }) {
                    ...
                    Text("Story No. 215")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 215") as NSString)
                    }
                    Text("Written By - Stephen Thompson")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Stephen Thompson") as NSString)
                        }
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Curse_of_the_Black_Spot")!], applicationActivities: nil)
                        }
                    }
