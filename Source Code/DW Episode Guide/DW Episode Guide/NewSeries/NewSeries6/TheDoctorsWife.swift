...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheDoctorsWifeWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Doctor%27s_Wife")!]))
                }
            }
                        ...
                        Image("TheDoctorsWife")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheDoctorsWife")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheDoctorsWife")! as UIImage)
                            } preview: {Image("TheDoctorsWife")}
                        Spacer()
                    }
                    Text("Story No. 216")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 216") as NSString)
                    }
                    Text("Written By - Neil Gaiman")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Doctor%27s_Wife")!], applicationActivities: nil)
                        }
                    }
