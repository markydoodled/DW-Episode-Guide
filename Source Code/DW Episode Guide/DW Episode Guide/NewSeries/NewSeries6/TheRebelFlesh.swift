...
struct TheRebelFlesh: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheRebelFleshClass.entity(),
            sortDescriptors: [],
            animation: .default)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheRebelFlesh")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheRebelFlesh")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheRebelFlesh")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Rebel_Flesh")!]))
                }
            }
                        ...
                        Image("TheRebelFlesh")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheRebelFlesh")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheRebelFlesh")! as UIImage)
                            } preview: {Image("TheRebelFlesh")}
                        Spacer()
                    }
                    Text("Story No. 217a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 217a") as NSString)
                    }
                    Text("Written By - Matthew Graham")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Rebel_Flesh")!], applicationActivities: nil)
                        }
                    }
...
struct TheRebelFlesh_Previews: PreviewProvider {
