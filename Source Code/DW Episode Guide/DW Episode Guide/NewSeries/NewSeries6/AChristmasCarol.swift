...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("AChristmasCarolWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("AChristmasCarol")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "AChristmasCarol")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "AChristmasCarol")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/A_Christmas_Carol_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("AChristmasCarol")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "AChristmasCarol")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "AChristmasCarol")! as UIImage)
                            } preview: {Image("AChristmasCarol")}
                        Spacer()
                    }
                    Text("Story No. 213")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 213") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/A_Christmas_Carol_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
