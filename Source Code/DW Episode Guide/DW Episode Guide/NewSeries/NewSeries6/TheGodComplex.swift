    ...
    ForEach(items) { item in
                    ...
                    Image("TheGodComplex")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheGodComplex")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheGodComplex")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_God_Complex")!]))
                }
            }
                        ...
                        Image("TheGodComplex")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheGodComplex")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheGodComplex")! as UIImage)
                            } preview: {Image("TheGodComplex")}
                        Spacer()
                    }
                    Text("Story No. 222")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 222") as NSString)
                    }
                    Text("Written By - Toby Whithouse")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_God_Complex")!], applicationActivities: nil)
                        }
                    }
