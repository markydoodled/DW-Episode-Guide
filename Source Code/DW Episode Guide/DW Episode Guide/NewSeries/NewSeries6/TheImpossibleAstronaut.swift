...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheImpossibleAstronautWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheImpossibleAstronaut")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheImpossibleAstronaut")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheImpossibleAstronaut")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Impossible_Astronaut")!]))
                }
            }
                        ...
                        Image("TheImpossibleAstronaut")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheImpossibleAstronaut")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheImpossibleAstronaut")! as UIImage)
                            } preview: {Image("TheImpossibleAstronaut")}
                        Spacer()
                    }
                    Text("Story No. 214a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 214a") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Impossible_Astronaut")!], applicationActivities: nil)
                        }
                    }
