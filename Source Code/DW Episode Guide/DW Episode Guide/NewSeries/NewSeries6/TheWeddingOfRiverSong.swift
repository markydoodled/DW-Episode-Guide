...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheWeddingOfRiverSongWatched") var watched: Bool = false
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheWeddingOfRiverSong")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheWeddingOfRiverSong")?.tiffRepresentation
                        ...
                        Image("TheWeddingOfRiverSong")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheWeddingOfRiverSong")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheWeddingOfRiverSong")! as UIImage)
                            } preview: {Image("TheWeddingOfRiverSong")}
                        Spacer()
                    }
                    Text("Story No. 224")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 224") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Wedding_of_River_Song")!], applicationActivities: nil)
                        }
                    }
