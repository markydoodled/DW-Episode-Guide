...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("UnderTheLakeWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("UnderTheLake")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "UnderTheLake")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "UnderTheLake")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Under_the_Lake")!]))
                }
            }
                        ...
                        Image("UnderTheLake")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "UnderTheLake")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "UnderTheLake")! as UIImage)
                            } preview: {Image("UnderTheLake")}
                        Spacer()
                    }
                    Text("Story No. 255a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 255a") as NSString)
                    }
                    Text("Written By - Toby Whithouse")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Under_the_Lake")!], applicationActivities: nil)
                        }
                    }
