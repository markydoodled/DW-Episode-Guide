...
struct LastChristmas: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: LastChristmasClass.entity(),
            sortDescriptors: [],
            animation: .default)
        ...
        ForEach(items) { item in
                    ...
                    Image("LastChristmas")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "LastChristmas")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "LastChristmas")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Last_Christmas_(Doctor_Who)")!]))
                }
            }
                ...
                Form {
                    HStack {
                        ...
                        Image("LastChristmas")
                            ...
                            } preview: {Image("LastChristmas")}
                        Spacer()
                    }
                    Text("Story No. 253")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 253") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Last_Christmas_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
...
struct LastChristmas_Previews: PreviewProvider {
