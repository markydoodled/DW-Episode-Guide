...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheGirlWhoDiedWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheGirlWhoDied")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheGirlWhoDied")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheGirlWhoDied")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Girl_Who_Died")!]))
                }
            }
                        ...
                        Image("TheGirlWhoDied")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheGirlWhoDied")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheGirlWhoDied")! as UIImage)
                            } preview: {Image("TheGirlWhoDied")}
                        Spacer()
                    }
                    Text("Story No. 256")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 256") as NSString)
                    }
                    Text("Written By - Jamie Mathieson\nAnd Steven Moffat")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Jamie Mathieson\nAnd Steven Moffat") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Girl_Who_Died")!], applicationActivities: nil)
                        }
                    }
