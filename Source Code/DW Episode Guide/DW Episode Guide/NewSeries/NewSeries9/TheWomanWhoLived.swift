...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheWomanWhoLivedWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
            ScrollView {
                HStack {
                    ...
                    Image("TheWomanWhoLived")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheWomanWhoLived")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheWomanWhoLived")?.tiffRepresentation
                    ...
                    Text("Story No. 257")
                            .font(.title3)
                        Text("Written By - Catherine Tregenna")
                            .font(.title3)
                }
                    Spacer()
                }
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Woman_Who_Lived")!]))
                }
            }
                        ...
                        Image("TheWomanWhoLived")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheWomanWhoLived")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheWomanWhoLived")! as UIImage)
                            } preview: {Image("TheWomanWhoLived")}
                        Spacer()
                    }
                    Text("Story No. 257")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 257") as NSString)
                    }
                    Text("Written By - Catherine Tregenna")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Catherine Tregenna") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Woman_Who_Lived")!], applicationActivities: nil)
                        }
                    }
