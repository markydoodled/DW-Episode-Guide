    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheZygonInversion")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheZygonInversion")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheZygonInversion")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheZygonInversion")
                                }) {
                    ...
                    Text("Story No. 258b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 258b") as NSString)
                    }
                    Text("Written By - Peter Harness\nAnd Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Zygon_Inversion")!], applicationActivities: nil)
                        }
                    }
