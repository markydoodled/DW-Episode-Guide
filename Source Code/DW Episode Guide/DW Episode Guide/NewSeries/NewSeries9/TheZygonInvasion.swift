...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheZygonInvasionWatched") var watched: Bool = false
    #if os(iOS)
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheZygonInvasion")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheZygonInvasion")?.tiffRepresentation
                        ...
                        Image("TheZygonInvasion")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheZygonInvasion")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheZygonInvasion")! as UIImage)
                            } preview: {Image("TheZygonInvasion")}
                        Spacer()
                    }
                    Text("Story No. 258a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 258a") as NSString)
                    }
                    Text("Written By - Peter Harness")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Zygon_Invasion")!], applicationActivities: nil)
                        }
                    }
