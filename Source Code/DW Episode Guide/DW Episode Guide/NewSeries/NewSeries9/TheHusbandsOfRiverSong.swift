...
struct TheHusbandsOfRiverSong: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheHusbandsOfRiverSongClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheHusbandsOfRiverSongClass>
        @State var showingShare = false
        @AppStorage("TheHusbandsOfRiverSongNotes") var notes = ""
        @AppStorage("THeHusbandsOfRiverSongWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheHusbandsOfRiverSong")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheHusbandsOfRiverSong")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheHusbandsOfRiverSong")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Husbands_of_River_Song")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheHusbandsOfRiverSong")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheHusbandsOfRiverSong")
                                }) {
                    ...
                    Text("Story No. 263")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 263") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Husbands_of_River_Song")!], applicationActivities: nil)
                        }
                    }
...
struct TheHusbandsOfRiverSong_Previews: PreviewProvider {
