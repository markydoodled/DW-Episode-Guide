...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheMagiciansApprenticeWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheMagiciansApprentice")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheMagiciansApprentice")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheMagiciansApprentice")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Magician%27s_Apprentice_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("TheMagiciansApprentice")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheMagiciansApprentice")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheMagiciansApprentice")! as UIImage)
                            } preview: {Image("TheMagiciansApprentice")}
                        Spacer()
                    }
                    Text("Story No. 254a")
                    .onDrag {
