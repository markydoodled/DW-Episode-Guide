...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("FaceTheRavenWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("FaceTheRaven")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "FaceTheRaven")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "FaceTheRaven")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Face_the_Raven")!]))
                }
            }
                        ...
                        Image("FaceTheRaven")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "FaceTheRaven")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "FaceTheRaven")! as UIImage)
                            } preview: {Image("FaceTheRaven")}
                        Spacer()
                    }
                    Text("Story No. 260")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 260") as NSString)
                    }
                    Text("Written By - Sarah Dollard")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Face_the_Raven")!], applicationActivities: nil)
                        }
                    }
