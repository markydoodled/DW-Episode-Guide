    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("SleepNoMore")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "SleepNoMore")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "SleepNoMore")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Sleep_No_More_(Doctor_Who)")!]))
            }
            .onAppear() {
                        ...
                        Image("SleepNoMore")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "SleepNoMore")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "SleepNoMore")! as UIImage)
                            } preview: {Image("SleepNoMore")}
                        Spacer()
                    }
                    Text("Story No. 259")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 259") as NSString)
                    }
                    Text("Written By - Mark Gatiss")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Sleep_No_More_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
