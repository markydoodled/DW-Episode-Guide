...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheWitchsFamiliarWatched") var watched: Bool = false
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheWitchsFamiliar")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheWitchsFamiliar")?.tiffRepresentation
                        ...
                        Image("TheWitchsFamiliar")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheWitchsFamiliar")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheWitchsFamiliar")! as UIImage)
                            } preview: {Image("TheWitchsFamiliar")}
                        Spacer()
                    }
                    Text("Story No. 254b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 254b") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Witch%27s_Familiar")!], applicationActivities: nil)
                        }
                    }
