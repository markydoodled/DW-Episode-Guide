...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("PlanetOfTheDeadWatched") var watched: Bool = false
                        ...
                        Image("PlanetOfTheDead")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "PlanetOfTheDead")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "PlanetOfTheDead")! as UIImage)
                            } preview: {Image("PlanetOfTheDead")}
                        Spacer()
                    }
                    Text("Story No. 200")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 200") as NSString)
                    }
                    Text("Written By - Russell T Davies\nAnd Gareth Roberts")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Russell T Davies\nAnd Gareth Roberts") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Planet_of_the_Dead")!], applicationActivities: nil)
                        }
                    }
