...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheNextDoctorWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                            ...
                            Image("TheNextDoctor")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheNextDoctor")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheNextDoctor")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Next_Doctor")!]))
                        }
                    }
                        ...
                        Image("TheNextDoctor")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheNextDoctor")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheNextDoctor")! as UIImage)
                            } preview: {Image("TheNextDoctor")}
                        Spacer()
                    }
                    Text("Story No. 199")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 199") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Next_Doctor")!], applicationActivities: nil)
                        }
                    }
