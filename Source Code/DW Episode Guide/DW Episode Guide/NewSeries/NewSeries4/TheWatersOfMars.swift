...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheWatersOfMarsWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("TheWatersOfMars")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheWatersOfMars")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheWatersOfMars")?.tiffRepresentation
                    ...
                    .touchBar {
                        ...
                        .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Waters_of_Mars")!]))
                    }
                    .onAppear() {
                        ...
                        Image("TheWatersOfMars")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheWatersOfMars")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheWatersOfMars")! as UIImage)
                            } preview: {Image("TheWatersOfMars")}
                        Spacer()
                    }
                    Text("Story No. 201")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 201") as NSString)
                    }
                    Text("Written By - Russell T Davies\nAnd Phil Ford")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Russell T Davies\nAnd Phil Ford") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Waters_of_Mars")!], applicationActivities: nil)
                        }
                    }
