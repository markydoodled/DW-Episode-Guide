...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheFiresOfPompeiiWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("TheFiresOfPompeii")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheFiresOfPompeii")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheFiresOfPompeii")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Fires_of_Pompeii")!]))
                        }
                    }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheFiresOfPompeii")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheFiresOfPompeii")
                                }) {
                    ...
                    Text("Story No. 190")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 190") as NSString)
                    }
                    Text("Written By - James Moran")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - James Moran") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Fires_of_Pompeii")!], applicationActivities: nil)
                        }
                    }
