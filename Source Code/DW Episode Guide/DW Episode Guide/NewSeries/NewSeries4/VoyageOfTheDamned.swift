...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("VoyageOfTheDamnedWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
                    ...
                    ScrollView {
                        HStack {
                            ...
                            Image("VoyageOfTheDamned")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "VoyageOfTheDamned")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                    ...
                    Text("Story No. 188")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 188") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Voyage_of_the_Damned_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
