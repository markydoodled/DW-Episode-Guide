...
struct ForestOfTheDead: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: ForestOfTheDeadClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<ForestOfTheDeadClass>
        @State var showingShare = false
        @AppStorage("ForestOfTheDeadNotes") var notes = ""
        @AppStorage("ForestOfTheDeadWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("ForestOfTheDead")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "ForestOfTheDead")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "ForestOfTheDead")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Forest_of_the_Dead")!]))
                        }
                    }
                        ...
                        Image("ForestOfTheDead")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ForestOfTheDead")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ForestOfTheDead")! as UIImage)
                            } preview: {Image("ForestOfTheDead")}
                        Spacer()
                    }
                    Text("Story No. 195b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 195b") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Forest_of_the_Dead")!], applicationActivities: nil)
                        }
                    }
...
struct ForestOfTheDead_Previews: PreviewProvider {
