        ...
        ForEach(items) { item in
                            ...
                            Image("SilenceInTheLibrary")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "SilenceInTheLibrary")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "SilenceInTheLibrary")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Silence_in_the_Library")!]))
                        }
                    }
                        ...
                        Image("SilenceInTheLibrary")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "SilenceInTheLibrary")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "SilenceInTheLibrary")! as UIImage)
                            } preview: {Image("SilenceInTheLibrary")}
                        Spacer()
                    }
                    Text("Story No. 195a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 195a") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Silence_in_the_Library")!], applicationActivities: nil)
                        }
                    }
