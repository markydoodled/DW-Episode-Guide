...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheDoctorsDaughterWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("TheDoctorsDaughter")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheDoctorsDaughter")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheDoctorsDaughter")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Doctor%27s_Daughter")!]))
                        }
                    }
                        ...
                        Image("TheDoctorsDaughter")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheDoctorsDaughter")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheDoctorsDaughter")! as UIImage)
                            } preview: {Image("TheDoctorsDaughter")}
                        Spacer()
                    }
                    Text("Story No. 193")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 193") as NSString)
                    }
                    Text("Written By - Stephen Greenhorn")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Stephen Greenhorn") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Doctor%27s_Daughter")!], applicationActivities: nil)
                        }
                    }
