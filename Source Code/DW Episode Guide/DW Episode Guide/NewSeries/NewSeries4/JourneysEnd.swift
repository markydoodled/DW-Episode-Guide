...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("JourneysEndWatched") var watched: Bool = false
                        ...
                        Image("JourneysEnd")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "JourneysEnd")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "JourneysEnd")! as UIImage)
                            } preview: {Image("JourneysEnd")}
                        Spacer()
                    }
                    Text("Story No. 198b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 198b") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Journey%27s_End_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
