...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheUnicornAndTheWaspWatched") var watched: Bool = false
    #if os(iOS)
                    ...
                    ScrollView {
                        HStack {
                            ...
                            Image("TheUnicornAndTheWasp")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "TheUnicornAndTheWasp")?.tiffRepresentation
                        ...
                        Image("TheUnicornAndTheWasp")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheUnicornAndTheWasp")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheUnicornAndTheWasp")! as UIImage)
                            } preview: {Image("TheUnicornAndTheWasp")}
                        Spacer()
                    }
                    Text("Story No. 194")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 194") as NSString)
                    }
                    Text("Written By - Gareth Roberts")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Unicorn_and_the_Wasp")!], applicationActivities: nil)
                        }
                    }
