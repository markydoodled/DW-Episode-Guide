...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("PartnersInCrimeWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                            ...
                            Image("PartnersInCrime")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "PartnersInCrime")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "PartnersInCrime")?.tiffRepresentation
                    ...
                    .toolbar {
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Partners_in_Crime_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("PartnersInCrime")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "PartnersInCrime")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "PartnersInCrime")! as UIImage)
                            } preview: {Image("PartnersInCrime")}
                        Spacer()
                    }
                    Text("Story No. 189")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 189") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Partners_in_Crime_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
