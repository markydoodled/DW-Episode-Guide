...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("ThePoisonSkyWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("ThePoisonSky")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "ThePoisonSky")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "ThePoisonSky")?.tiffRepresentation
                    ...
                    .touchBar {
                        ...
                        .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Poison_Sky")!]))
                    }
                    .onAppear() {
                        ...
                        Image("ThePoisonSky")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ThePoisonSky")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ThePoisonSky")! as UIImage)
                            } preview: {Image("ThePoisonSky")}
                        Spacer()
                    }
                    Text("Story No. 192b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 192b") as NSString)
                    }
                    Text("Written By - Helen Raynor")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Poison_Sky")!], applicationActivities: nil)
                        }
                    }
