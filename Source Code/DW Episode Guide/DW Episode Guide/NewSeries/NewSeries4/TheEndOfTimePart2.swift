                            ...
                            Image("TheEndOfTimePart2")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheEndOfTimePart2")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheEndOfTimePart2")?.tiffRepresentation
                        ...
                        Image("TheEndOfTimePart2")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheEndOfTimePart2")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheEndOfTimePart2")! as UIImage)
                            } preview: {Image("TheEndOfTimePart2")}
                        Spacer()
                    }
                    Text("Story No. 202b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 202b") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
