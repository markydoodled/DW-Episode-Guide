...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("PlanetOfTheOodWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("PlanetOfTheOod")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "PlanetOfTheOod")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "PlanetOfTheOod")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Planet_of_the_Ood")!]))
                        }
                    }
                        ...
                        Image("PlanetOfTheOod")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "PlanetOfTheOod")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "PlanetOfTheOod")! as UIImage)
                            } preview: {Image("PlanetOfTheOod")}
                        Spacer()
                    }
                    Text("Story No. 191")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 191") as NSString)
                    }
                    Text("Written By - Keith Temple")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Keith Temple") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Planet_of_the_Ood")!], applicationActivities: nil)
                        }
                    }
