    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("OnceUponTime")
                        ...
                        .onDrag {
                            let data = NSImage(named: "OnceUponTime")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("OnceUponTime")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "OnceUponTime")
                                }) {
                    ...
                    Text("Story No. 297c")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 297c") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Once,_Upon_Time")!], applicationActivities: nil)
                        }
                    }
