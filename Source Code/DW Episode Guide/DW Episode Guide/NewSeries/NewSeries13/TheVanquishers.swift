...
struct TheVanquishers: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheVanquishersClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheVanquishersClass>
        @State var showingShare = false
        @AppStorage("TheVanquishersNotes") var notes = ""
        @AppStorage("TheVanquishersWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheVanquishers")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheVanquishers")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheVanquishers")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Vanquishers")!]))
                }
            }
                        ...
                        Image("TheVanquishers")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheVanquishers")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheVanquishers")! as UIImage)
                            } preview: {Image("TheVanquishers")}
                        Spacer()
                    }
                    Text("Story No. 297f")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 297f") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Vanquishers")!], applicationActivities: nil)
                        }
                    }
...
struct TheVanquishers_Previews: PreviewProvider {
