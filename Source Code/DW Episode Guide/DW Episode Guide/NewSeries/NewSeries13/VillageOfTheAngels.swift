...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("VillageOfTheAngelsWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("VillageOfTheAngels")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "VillageOfTheAngels")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "VillageOfTheAngels")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Village_of_the_Angels")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("VillageOfTheAngels")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "VillageOfTheAngels")
                                }) {
                    ...
                    Text("Story No. 297d")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 297d") as NSString)
                    }
                    Text("Written By - Chris Chibnall\nAnd Maxine Alderton")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Chris Chibnall\nAnd Maxine Alderton") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Village_of_the_Angels")!], applicationActivities: nil)
                        }
                    }
