...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheHalloweenApocalypseWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheHalloweenApocalypse")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheHalloweenApocalypse")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheHalloweenApocalypse")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Halloween_Apocalypse")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheHalloweenApocalypse")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheHalloweenApocalypse")
                                }) {
                    ...
                    Text("Story No. 297a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 297a") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Halloween_Apocalypse")!], applicationActivities: nil)
                        }
                    }
