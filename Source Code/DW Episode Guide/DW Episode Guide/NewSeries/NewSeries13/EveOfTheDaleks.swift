...
struct EveOfTheDaleks: View {
    @Environment(\.managedObjectContext) private var viewContext
            ...
            @AppStorage("EveOfTheDaleksWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("EveOfTheDaleks")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "EveOfTheDaleks")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "EveOfTheDaleks")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Eve_of_the_Daleks")!]))
                }
            }
                ...
                Form {
                    HStack {
                        ...
                        Image("EveOfTheDaleks")
                            ...
                            } preview: {Image("EveOfTheDaleks")}
                        Spacer()
                    }
                    Text("Story No. 298")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 298") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Eve_of_the_Daleks")!], applicationActivities: nil)
                        }
                    }
