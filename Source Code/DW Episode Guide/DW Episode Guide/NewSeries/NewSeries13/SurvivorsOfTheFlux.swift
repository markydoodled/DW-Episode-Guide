    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("SurvivorsOfTheFlux")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "SurvivorsOfTheFlux")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "SurvivorsOfTheFlux")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Survivors_of_the_Flux")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("SurvivorsOfTheFlux")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "SurvivorsOfTheFlux")
                                }) {
                    ...
                    Text("Story No. 297e")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 297e") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Survivors_of_the_Flux")!], applicationActivities: nil)
                        }
                    }
