    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ScrollView {
                        HStack {
                            ...
                            Image("TheLazarusExperiment")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "TheLazarusExperiment")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Lazarus_Experiment")!]))
                        }
                    }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheLazarusExperiment")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheLazarusExperiment")
                                }) {
                    ...
                    Text("Story No. 183")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 183") as NSString)
                    }
                    Text("Written By - Stephen Greenhorn")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Lazarus_Experiment")!], applicationActivities: nil)
                        }
                    }
