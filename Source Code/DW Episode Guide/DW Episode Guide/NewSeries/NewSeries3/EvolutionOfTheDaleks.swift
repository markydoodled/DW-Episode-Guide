...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("EvolutionOfTheDaleksWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                            ...
                            Image("EvolutionOfTheDaleks")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "EvolutionOfTheDaleks")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "EvolutionOfTheDaleks")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Evolution_of_the_Daleks")!]))
                        }
                    }
                        ...
                        Image("EvolutionOfTheDaleks")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "EvolutionOfTheDaleks")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "EvolutionOfTheDaleks")! as UIImage)
                            } preview: {Image("EvolutionOfTheDaleks")}
                        Spacer()
                    }
                    Text("Story No. 182b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 182b") as NSString)
                    }
                    Text("Written By - Helen Raynor")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Helen Raynor") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Evolution_of_the_Daleks")!], applicationActivities: nil)
                        }
                    }
