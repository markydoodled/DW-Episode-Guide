...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheFamilyOfBloodWatched") var watched: Bool = false
    #if os(iOS)
                    ...
                    ScrollView {
                        HStack {
                            ...
                            Image("TheFamilyOfBlood")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "TheFamilyOfBlood")?.tiffRepresentation
                        ...
                        Image("TheFamilyOfBlood")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheFamilyOfBlood")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheFamilyOfBlood")! as UIImage)
                            } preview: {Image("TheFamilyOfBlood")}
                        Spacer()
                    }
                    Text("Story No. 185b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 185b") as NSString)
                    }
                    Text("Written By - Paul Cornell")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Family_of_Blood")!], applicationActivities: nil)
                        }
                    }
