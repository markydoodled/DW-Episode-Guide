...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("DaleksInManhattanWatched") var watched: Bool = false 
    #if os(iOS)
                    ...
                    ScrollView {
                        HStack {
                            ...
                            Image("DaleksInManhattan")
                                ...
                                .onDrag {
                                    let data = NSImage(named: "DaleksInManhattan")?.tiffRepresentation
                        ...
                        Image("DaleksInManhattan")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "DaleksInManhattan")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "DaleksInManhattan")! as UIImage)
                            } preview: {Image("DaleksInManhattan")}
                        Spacer()
                    }
                    Text("Story No. 182a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 182a") as NSString)
                    }
                    Text("Written By - Helen Raynor")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Daleks_in_Manhattan")!], applicationActivities: nil)
                        }
                    }
