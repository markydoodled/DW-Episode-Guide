...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("SmithAndJonesWatched") var watched: Bool = false
                            ...
                            Image("SmithAndJones")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "SmithAndJones")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "SmithAndJones")?.tiffRepresentation
                        ...
                        Image("SmithAndJones")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "SmithAndJones")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "SmithAndJones")! as UIImage)
                            } preview: {Image("SmithAndJones")}
                        Spacer()
                    }
                    Text("Story No. 179")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 179") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Smith_and_Jones_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
