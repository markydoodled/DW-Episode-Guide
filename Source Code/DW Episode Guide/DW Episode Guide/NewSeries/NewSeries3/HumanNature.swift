    ...
    var body: some View {
        ...
        ForEach(items) { item in
                            ...
                            Image("HumanNature")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "HumanNature")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "HumanNature")?.tiffRepresentation
                    ...
                    ToolbarItem(placement: .primaryAction) {
                        ...
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Human_Nature_(Doctor_Who)")!]))
                        }
                    }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("HumanNature")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "HumanNature")
                                }) {
                    ...
                    Text("Story No. 185a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 185a") as NSString)
                    }
                    Text("Written By - Paul Cornell")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Human_Nature_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
