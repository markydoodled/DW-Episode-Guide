...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheRunawayBrideWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                            ...
                            Image("TheRunawayBride")
                                ...
                                .contextMenu {
                                    Button(action: {let pasteboard = NSPasteboard.general
                                        ...
                                        pasteboard.writeObjects([NSImage(named: "TheRunawayBride")!])
                                    }) {
                                        Text("Copy")
                                    }
                                }
                                .onDrag {
                                    let data = NSImage(named: "TheRunawayBride")?.tiffRepresentation
                    ...
                    .toolbar {
                        ToolbarItem(placement: .primaryAction) {
                            ...
                            .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Runaway_Bride_(Doctor_Who)")!]))
                        }
                    }
                        ...
                        Image("TheRunawayBride")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheRunawayBride")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheRunawayBride")! as UIImage)
                            } preview: {Image("TheRunawayBride")}
                        Spacer()
                    }
                    Text("Story No. 178")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 178") as NSString)
                    }
                    Text("Written By - Russell T Davies")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Runaway_Bride_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
