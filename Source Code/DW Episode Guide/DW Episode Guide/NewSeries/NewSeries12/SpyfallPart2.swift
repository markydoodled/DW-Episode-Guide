                    ...
                    Image("SpyfallPart2")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "SpyfallPart2")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "SpyfallPart2")?.tiffRepresentation
                        ...
                        Image("SpyfallPart2")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "SpyfallPart2")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "SpyfallPart2")! as UIImage)
                            } preview: {Image("SpyfallPart2")}
                        Spacer()
                    }
                    Text("Story No. 288b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 288b") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Spyfall_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
...
struct SpyfallPart2_Previews: PreviewProvider {
