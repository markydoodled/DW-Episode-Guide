...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("AscensionOfTheCybermenWatched") var watched: Bool = false
    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("AscensionOfTheCybermen")
                        ...
                        .onDrag {
                            let data = NSImage(named: "AscensionOfTheCybermen")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("AscensionOfTheCybermen")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "AscensionOfTheCybermen")
                                }) {
                    ...
                    Text("Story No. 295a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 295a") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Ascension_of_the_Cybermen")!], applicationActivities: nil)
                        }
                    }
