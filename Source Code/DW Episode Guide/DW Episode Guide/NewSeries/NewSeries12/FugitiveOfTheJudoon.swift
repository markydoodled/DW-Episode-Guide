...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("FugitiveOfTheJudoonWatched") var watched: Bool = false
    #if os(iOS)
            ...
            ScrollView {
                HStack {
                    ...
                    Image("FugitiveOfTheJudoon")
                        ...
                        .onDrag {
                            let data = NSImage(named: "FugitiveOfTheJudoon")?.tiffRepresentation
                        ...
                        Image("FugitiveOfTheJudoon")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "FugitiveOfTheJudoon")
                                }) {
