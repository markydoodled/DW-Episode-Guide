            ...
            ScrollView {
                HStack {
                    ...
                    Image("SpyfallPart1")
                        ...
                        .onDrag {
                            let data = NSImage(named: "SpyfallPart1")?.tiffRepresentation
                        ...
                        Image("SpyfallPart1")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "SpyfallPart1")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "SpyfallPart1")! as UIImage)
                            } preview: {Image("SpyfallPart1")}
                        Spacer()
                    }
                    Text("Story No. 288a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 288a") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
