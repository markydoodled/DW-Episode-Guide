...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheTimelessChildrenWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("TheTimelessChildren")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheTimelessChildren")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheTimelessChildren")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Timeless_Children")!]))
                }
            }
                        ...
                        Image("TheTimelessChildren")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheTimelessChildren")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheTimelessChildren")! as UIImage)
                            } preview: {Image("TheTimelessChildren")}
                        Spacer()
                    }
                    Text("Story No. 295b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 295b") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Timeless_Children")!], applicationActivities: nil)
                        }
                    }
