...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @FetchRequest(entity: PraxeusClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<PraxeusClass>
        @State var showingShare = false
        @AppStorage("PraxeusNotes") var notes = ""
        @AppStorage("PraxeusWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("Praxeus")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "Praxeus")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "Praxeus")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Praxeus")!]))
                }
            }
                        ...
                        Image("Praxeus")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Praxeus")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Praxeus")! as UIImage)
                            } preview: {Image("Praxeus")}
                        Spacer()
                    }
                    Text("Story No. 292")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 292") as NSString)
                    }
                    Text("Written By - Pete McTighe\nAnd Chris Chibnall")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Pete McTighe\nAnd Chris Chibnall") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Praxeus")!], applicationActivities: nil)
                        }
                    }
...
struct Praxeus_Previews: PreviewProvider {
