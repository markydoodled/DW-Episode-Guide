...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("NikolaTeslasNightOfTerrorWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
            ScrollView {
                HStack {
                    Spacer()
                    Image("NikolaTeslasNightOfTerror")
                        .resizable()
                        .scaledToFill()
                        .cornerRadius(25)
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "NikolaTeslasNightOfTerror")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "NikolaTeslasNightOfTerror")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Nikola_Tesla%27s_Night_of_Terror")!]))
            }
            .onAppear() {
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("NikolaTeslasNightOfTerror")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "NikolaTeslasNightOfTerror")
                                }) {
                    ...
                    Text("Story No. 290")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 290") as NSString)
                    }
                    Text("Written By - Nina Metivier")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Nina Metivier") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Nikola_Tesla%27s_Night_of_Terror")!], applicationActivities: nil)
                        }
                    }
