...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("RevolutionOfTheDaleksWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("RevolutionOfTheDaleks")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "RevolutionOfTheDaleks")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "RevolutionOfTheDaleks")?.tiffRepresentation
            ...
            .touchBar {
                ...
                .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Revolution_of_the_Daleks")!]))
            }
            .onAppear() {
                        ...
                        Image("RevolutionOfTheDaleks")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "RevolutionOfTheDaleks")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "RevolutionOfTheDaleks")! as UIImage)
                            } preview: {Image("RevolutionOfTheDaleks")}
                        Spacer()
                    }
                    Text("Story No. 296")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 296") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Revolution_of_the_Daleks")!], applicationActivities: nil)
                        }
                    }
