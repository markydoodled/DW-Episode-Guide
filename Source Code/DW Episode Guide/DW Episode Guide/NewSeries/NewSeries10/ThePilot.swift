...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("ThePilotWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("ThePilot")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "ThePilot")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "ThePilot")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Pilot_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("ThePilot")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ThePilot")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ThePilot")! as UIImage)
                            } preview: {Image("ThePilot")}
                        Spacer()
                    }
                    Text("Story No. 265")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 265") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Pilot_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
