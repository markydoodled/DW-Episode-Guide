        ...
        ForEach(items) { item in
                    ...
                    Image("KnockKnock")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "KnockKnock")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "KnockKnock")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Knock_Knock_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("KnockKnock")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "KnockKnock")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "KnockKnock")! as UIImage)
                            } preview: {Image("KnockKnock")}
                        Spacer()
                    }
                    Text("Story No. 268")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 268") as NSString)
                    }
                    Text("Written By - Mike Bartlett")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Mike Bartlett") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Knock_Knock_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
