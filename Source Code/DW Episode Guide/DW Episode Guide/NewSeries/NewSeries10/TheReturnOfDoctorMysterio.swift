//
//  TheReturnOfDoctorMysterio.swift
//  DW Episode Guide
//
...
struct TheReturnOfDoctorMysterio: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheReturnOfDoctorMysterioClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheReturnOfDoctorMysterioClass>
        @State var showingShare = false
        @AppStorage("TheReturnOfDoctorMysterioNotes") var notes = ""
        @AppStorage("TheReturnOfDoctorMysterioWatched") var watched: Bool = false
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("TheReturnOfDoctorMysterio")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheReturnOfDoctorMysterio")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheReturnOfDoctorMysterio")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Return_of_Doctor_Mysterio")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheReturnOfDoctorMysterio")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheReturnOfDoctorMysterio")
                                }) {
                    ...
                    Text("Story No. 264")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 264") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Return_of_Doctor_Mysterio")!], applicationActivities: nil)
                        }
                    }
...
struct TheReturnOfDoctorMysterio_Previews: PreviewProvider {
