    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TwiceUponATime")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TwiceUponATime")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TwiceUponATime")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TwiceUponATime")
                                }) {
                    ...
                    Text("Story No. 276")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 276") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Twice_Upon_a_Time_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
...
struct TwiceUponATime_Previews: PreviewProvider {
