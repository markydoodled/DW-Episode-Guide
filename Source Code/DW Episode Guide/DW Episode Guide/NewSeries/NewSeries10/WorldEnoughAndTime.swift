    ...
    var body: some View {
                    ...
                    Image("WorldEnoughAndTime")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "WorldEnoughAndTime")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "WorldEnoughAndTime")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("WorldEnoughAndTime")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "WorldEnoughAndTime")
                                }) {
                    ...
                    Text("Story No. 275a")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 275a") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/World_Enough_and_Time_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
