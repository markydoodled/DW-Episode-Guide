...
struct TheLieOfTheLand: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheLieOfTheLandClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheLieOfTheLandClass>
        @State var showingShare = false
        @AppStorage("TheLieOfTheLandNotes") var notes = ""
        @AppStorage("TheLieOfTheLandWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
            ScrollView {
                HStack {
                    ...
                    Image("LieOfTheLand")
                        ...
                        .onDrag {
                            let data = NSImage(named: "LieOfTheLand")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Lie_of_the_Land")!]))
                }
            }
                        ...
                        Image("LieOfTheLand")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "LieOfTheLand")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "LieOfTheLand")! as UIImage)
                            } preview: {Image("LieOfTheLand")}
                        Spacer()
                    }
                    Text("Story No. 272")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 272") as NSString)
                    }
                    Text("Written By - Toby Whithouse")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Lie_of_the_Land")!], applicationActivities: nil)
                        }
                    }
...
struct TheLieOfTheLand_Previews: PreviewProvider {
