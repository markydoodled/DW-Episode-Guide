...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @FetchRequest(entity: ThinIceClass.entity(),
            sortDescriptors: [],
            animation: .default)
        ...
        ForEach(items) { item in
                    ...
                    Image("ThinIce")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "ThinIce")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "ThinIce")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Thin_Ice_(Doctor_Who_episode)")!]))
                }
            }
                        ...
                        Image("ThinIce")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ThinIce")
                                }) {
...
struct ThinIce_Previews: PreviewProvider {
