...
struct TheDoctorFalls: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheDoctorFallsClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheDoctorFallsClass>
        @State var showingShare = false
        @AppStorage("TheDoctorFallsNotes") var notes = ""
        @AppStorage("TheDoctorFallsWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheDoctorFalls")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheDoctorFalls")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheDoctorFalls")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Doctor_Falls")!]))
                }
            }
                        ...
                        Image("TheDoctorFalls")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheDoctorFalls")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheDoctorFalls")! as UIImage)
                            } preview: {Image("TheDoctorFalls")}
                        Spacer()
                    }
                    Text("Story No. 275b")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 275b") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Doctor_Falls")!], applicationActivities: nil)
                        }
                    }
...
struct TheDoctorFalls_Previews: PreviewProvider {
