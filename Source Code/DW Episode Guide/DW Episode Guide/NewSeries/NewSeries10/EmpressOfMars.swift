...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("EmpressOfMarsWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("EmpressOfMars")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "EmpressOfMars")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "EmpressOfMars")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Empress_of_Mars")!]))
                }
            }
                        ...
                        Image("EmpressOfMars")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "EmpressOfMars")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "EmpressOfMars")! as UIImage)
                            } preview: {Image("EmpressOfMars")}
                        Spacer()
                    }
                    Text("Story No. 273")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 273") as NSString)
                    }
                    Text("Written By - Mark Gatiss")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Empress_of_Mars")!], applicationActivities: nil)
                        }
                    }
