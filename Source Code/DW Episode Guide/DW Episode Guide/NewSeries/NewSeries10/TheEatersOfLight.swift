...
struct TheEatersOfLight: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: TheEatersOfLightClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<TheEatersOfLightClass>
        @State var showingShare = false
        @AppStorage("TheEatersOfLightNotes") var notes = ""
        @AppStorage("TheEatersOfLightWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("TheEatersOfLight")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "TheEatersOfLight")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "TheEatersOfLight")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/The_Eaters_of_Light")!]))
                }
            }
                        ...
                        Image("TheEatersOfLight")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheEatersOfLight")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "TheEatersOfLight")! as UIImage)
                            } preview: {Image("TheEatersOfLight")}
                        Spacer()
                    }
                    Text("Story No. 274")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 274") as NSString)
                    }
                    Text("Written By - Rona Munro")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Rona Munro") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Eaters_of_Light")!], applicationActivities: nil)
                        }
                    }
...
struct TheEatersOfLight_Previews: PreviewProvider {
