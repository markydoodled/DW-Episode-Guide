...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("ExtremisWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("Extremis")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "Extremis")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "Extremis")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Extremis_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("Extremis")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Extremis")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Extremis")! as UIImage)
                            } preview: {Image("Extremis")}
                        Spacer()
                    }
                    Text("Story No. 270")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 270") as NSString)
                    }
                    Text("Written By - Steven Moffat")
                        .onDrag {
                ...
                .toolbar {
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Extremis_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
