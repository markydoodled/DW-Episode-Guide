...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("OxygenWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("Oxygen")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "Oxygen")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "Oxygen")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Oxygen_(Doctor_Who)")!]))
                }
            }
                        ...
                        Image("Oxygen")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Oxygen")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Oxygen")! as UIImage)
                            } preview: {Image("Oxygen")}
                        Spacer()
                    }
                    Text("Story No. 269")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 269") as NSString)
                    }
                    Text("Written By - Jamie Mathieson")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Oxygen_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
