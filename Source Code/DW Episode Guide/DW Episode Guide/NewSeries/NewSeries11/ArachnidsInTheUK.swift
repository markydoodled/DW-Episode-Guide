...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("ArachnidsInTheUKWatched") var watched: Bool = false
        ...
        ForEach(items) { item in
                    ...
                    Image("ArachnidsInTheUK")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "ArachnidsInTheUK")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "ArachnidsInTheUK")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Arachnids_in_the_UK")!]))
                }
            }
                        ...
                        Image("ArachnidsInTheUK")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ArachnidsInTheUK")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ArachnidsInTheUK")! as UIImage)
                            } preview: {Image("ArachnidsInTheUK")}
                        Spacer()
                    }
                    Text("Story No. 280")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 280") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Arachnids_in_the_UK")!], applicationActivities: nil)
                        }
                    }
