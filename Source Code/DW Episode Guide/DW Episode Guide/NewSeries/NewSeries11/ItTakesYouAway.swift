...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("ItTakesYouAwayWatched") var watched: Bool = false
    #if os(iOS)
        ...
        ForEach(items) { item in
                    ...
                    Image("ItTakesYouAway")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "ItTakesYouAway")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "ItTakesYouAway")?.tiffRepresentation
            ...
            .toolbar {
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/It_Takes_You_Away")!]))
                }
            }
                        ...
                        Image("ItTakesYouAway")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "ItTakesYouAway")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "ItTakesYouAway")! as UIImage)
                            } preview: {Image("ItTakesYouAway")}
                        Spacer()
                    }
                    Text("Story No. 285")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 285") as NSString)
                    }
                    Text("Written By - Ed Hime")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/It_Takes_You_Away")!], applicationActivities: nil)
                        }
                    }
