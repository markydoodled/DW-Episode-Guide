...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheBattleOfRanskoorAvKolosWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheBattleOfRanskoorAvKolos")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheBattleOfRanskoorAvKolos")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheBattleOfRanskoorAvKolos")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheBattleOfRanskoorAvKolos")
                                }) {
                    ...
                    Text("Story No. 286")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 286") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Battle_of_Ranskoor_Av_Kolos")!], applicationActivities: nil)
                        }
                    }
