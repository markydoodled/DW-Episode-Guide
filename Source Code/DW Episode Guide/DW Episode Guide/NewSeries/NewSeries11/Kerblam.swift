...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @FetchRequest(entity: KerblamClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<KerblamClass>
        @State var showingShare = false
        @AppStorage("KerblamNotes") var notes = ""
        @AppStorage("KerblamWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
        ...
        ForEach(items) { item in
                    ...
                    Image("Kerblam")
                        ...
                        .contextMenu {
                            Button(action: {let pasteboard = NSPasteboard.general
                                ...
                                pasteboard.writeObjects([NSImage(named: "Kerblam")!])
                            }) {
                                Text("Copy")
                            }
                        }
                        .onDrag {
                            let data = NSImage(named: "Kerblam")?.tiffRepresentation
            ...
            ToolbarItem(placement: .primaryAction) {
                ...
                ToolbarItem(placement: .primaryAction) {
                    ...
                    .background(SharingsPicker(isPresented: $showingShare, sharingItems: [URL(string: "https://en.wikipedia.org/wiki/Kerblam!")!]))
                }
            }
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("Kerblam")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Kerblam")
                                }) {
                    ...
                    Text("Story No. 283")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 283") as NSString)
                    }
                    Text("Written By - Pete McTighe")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Pete McTighe") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Kerblam!")!], applicationActivities: nil)
                        }
                    }
...
struct Kerblam_Previews: PreviewProvider {
