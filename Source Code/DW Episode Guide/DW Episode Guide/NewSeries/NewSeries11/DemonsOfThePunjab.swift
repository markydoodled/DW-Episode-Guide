...
struct DemonsOfThePunjab: View {
@Environment(\.managedObjectContext) private var viewContext

        @FetchRequest(entity: DemonsOfThePunjabClass.entity(),
            sortDescriptors: [],
            animation: .default)
        private var items: FetchedResults<DemonsOfThePunjabClass>
        @State var showingShare = false
        @AppStorage("DemonsOfThePunjabNotes") var notes = ""
        @AppStorage("DemonsOfThePunjabWatched") var watched: Bool = false
    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("DemonsOfThePunjab")
                        ...
                        .onDrag {
                            let data = NSImage(named: "DemonsOfThePunjab")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("DemonsOfThePunjab")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "DemonsOfThePunjab")
                                }) {
                    ...
                    Text("Story No. 282")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 282") as NSString)
                    }
                    Text("Written By - Vinay Patel")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Vinay Patel") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Demons_of_the_Punjab")!], applicationActivities: nil)
                        }
                    }
...
struct DemonsOfThePunjab_Previews: PreviewProvider {
