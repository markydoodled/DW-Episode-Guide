...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("RosaWatched") var watched: Bool = false
    #if os(iOS)
            ...
            ScrollView {
                HStack {
                    ...
                    Image("Rosa")
                        ...
                        .onDrag {
                            let data = NSImage(named: "Rosa")?.tiffRepresentation
                        ...
                        Image("Rosa")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "Rosa")
                                }) {
                                    Label("Copy", systemImage: "doc.on.doc")
                                }
                            }
                            .onDrag {
                                return NSItemProvider(object: UIImage(named: "Rosa")! as UIImage)
                            } preview: {Image("Rosa")}
                        Spacer()
                    }
                    Text("Story No. 279")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 279") as NSString)
                    }
                    Text("Written By - Malorie Blackman\nAnd Chris Chibnall")
                        .onDrag {
                            return NSItemProvider(object: String("Written By - Malorie Blackman\nAnd Chris Chibnall") as NSString)
                        }
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/Rosa_(Doctor_Who)")!], applicationActivities: nil)
                        }
                    }
