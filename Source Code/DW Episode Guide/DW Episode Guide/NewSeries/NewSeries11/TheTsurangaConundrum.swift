...
@Environment(\.managedObjectContext) private var viewContext
        ...
        @AppStorage("TheTsurangaConundrumWatched") var watched: Bool = false
    #if os(iOS)
    ...
    var body: some View {
            ...
            ScrollView {
                HStack {
                    ...
                    Image("TheTsurangaConundrum")
                        ...
                        .onDrag {
                            let data = NSImage(named: "TheTsurangaConundrum")?.tiffRepresentation
        ...
        if horizontalSizeClass == .compact {
                ...
                Form {
                        ...
                        Image("TheTsurangaConundrum")
                            ...
                            .contextMenu {
                                Button(action: {let pasteboard = UIPasteboard.general
                                    pasteboard.image = UIImage(named: "TheTsurangaConundrum")
                                }) {
                    ...
                    Text("Story No. 281")
                    .onDrag {
                        return NSItemProvider(object: String("Story No. 281") as NSString)
                    }
                    Text("Written By - Chris Chibnall")
                        .onDrag {
               ...
               ToolbarItem(placement: .navigationBarTrailing) {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        ...
                        .sheet(isPresented: $showingShare) {
                            ActivityView(activityItems: [URL(string: "https://en.wikipedia.org/wiki/The_Tsuranga_Conundrum")!], applicationActivities: nil)
                        }
                    }
